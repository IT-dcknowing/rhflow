    ...
    <div class="col-12">
        ...
        <div class="row mt-3">
            <div class="col-xl-12 col-lg-12">
                <div class="card">  
                    <div class="card-body">
                        <form method="POST" action="{{ route('super-admin.enterprises.store') }}" class="needs-validation" enctype="multipart/form-data" novalidate>
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-7">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select select2 @error('industry') is-invalid @enderror"
                                            ...
                                            @foreach($sectors as $sector)
                                                <option value="{{ $sector->slug }}" {{ old('industry') == $sector->slug ? 'selected' : '' }}>{{ $sector->name }}</option>
                                            @endforeach
                                        </select>
                                        @error('industry')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            <label for="size" class="form-label">Taille de l'entreprise <span class="text-danger">*</span></label>
                                            <select class="form-select @error('size') is-invalid @enderror"
                                                ...
                                                <option value="small" {{ old('small') == 'size' ? 'selected' : '' }}>Petite entreprise (1-50 employés)</option>
                                                <option value="medium" {{ old('medium') == 'size' ? 'selected' : '' }}>Moyenne entreprise (51-200 employés)</option>
                                                <option value="large" {{ old('large') == 'size' ? 'selected' : '' }}>Grande entreprise (201-1000 employés)</option>
                                                <option value="enterprise" {{ old('enterprise') == 'size' ? 'selected' : '' }}>Grande entreprise (1000+ employés)</option>
                                            </select>
                                            @error('size')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select class="form-select @error('timezone') is-invalid @enderror"
                                                ...
                                                <option value="Africa/Abidjan" {{ old('timezone', 'Africa/Abidjan') == 'Africa/Abidjan' ? 'selected' : '' }}>Africa/Abidjan (GMT+0)</option>
                                                <option value="Europe/Paris" {{ old('timezone') == 'Europe/Paris' ? 'selected' : '' }}>Europe/Paris (GMT+1)</option>
                                                ...
                                                <option value="America/Montreal" {{ old('timezone') == 'America/Montreal' ? 'selected' : '' }}>America/Montreal (GMT-5)</option>  
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea class="form-control @error('description') is-invalid @enderror"
                                                ...
                                                name="description"
                                                rows="3"
                                                placeholder="Brève description de l'entreprise...">{{ old('description') }}</textarea>
                                        @error('description')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-lg-5">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('plan') is-invalid @enderror"
                                            ...
                                            @foreach($packs as $packs)
                                                <option value="{{ $packs->id }}" {{ old('plan') == $packs->id ? 'selected' : '' }}>{{ $packs->name }}</option>
                                            @endforeach
                                        </select>
                                        @error('plan')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                    ...
                                    <!-- Config dynamique d'activation du pack -->
                                        ...
                                        <div class="border rounded p-3 bg-light">
                                            ...
                                            <div class="row g-3 align-items-center mb-2">
                                                <div class="col-12">
                                                    ...
                                                    <input type="hidden" name="activation_timing" id="activation_timing" value="{{ old('activation_timing', 'now') }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row g-3 mb-2" id="startDateRow" style="display:none;">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="date" class="form-control" id="subscription_start_date" name="subscription_start_date" value="{{ old('subscription_start_date') }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row g-3">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="date" class="form-control" id="calculated_start_date" value="" readonly>
                                                </div>
                                                <div class="col-md-6">
                                                    <label for="subscription_end_date" class="form-label">Date de fin</label>
                                                    <input type="date" class="form-control" id="subscription_end_date" name="subscription_end_date" value="{{ old('subscription_end_date') }}" readonly>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number"
                                            ...
                                            value="{{ old('working_days_per_week', 5) }}"
                                            min="1"
                                            max="7">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <textarea class="form-control @error('address') is-invalid @enderror"
                                                    ...
                                                    name="address"
                                                    rows="2"
                                                    placeholder="Numéro, rue, bâtiment, appartement...">{{ old('address') }}</textarea>
                                            @error('address')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                            <small class="form-text text-muted">
                                                Ajoutez les détails de l'adresse (numéro de rue, bâtiment, etc.)
                                            </small>
                                        </div>
...
function generatePassword() {
    ...
    const result = checkPasswordStrength(password);
        if (result.strength < 4) {
            alert(`Le mot de passe généré est trop faible. Veuillez le modifier pour qu'il contienne au moins 8 caractères, une minuscule, une majuscule, un chiffre et un symbole.`);
        ...
        else feedback.push("Au moins un symbole");
