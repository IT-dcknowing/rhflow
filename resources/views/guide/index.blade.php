...
<meta name="description" content="Guide d'utilisation complet du logiciel RH Flow : gestion des employés, contrats, paie, congés, déclarations fiscales et pointage pour les entreprises ivoiriennes.">
...
a:hover { border-bottom-color: var(--primary-bright); }
...
.callout.warning { background: var(--warning-bg); border-color: var(--warning-border); color: var(--warning); }
.callout.warning .callout-title { color: var(--warning); }
.callout.error { background: var(--error-bg); border-color: var(--error-border); color: var(--error); }
...
.steps li strong { display: block; color: var(--text-main); margin-bottom: 4px; font-size: 15px; }
...
.toc-inline li { break-inside: avoid; margin-bottom: 6px; font-size: 14px; }
...
details > p, details > ul { margin-top: 12px; font-size: 14.5px; }
...
/* Print */
@media print {
  header, nav, .menu-toggle, .sidebar-overlay { display: none !important; }
...
<header role="banner">
  ...
  <div class="header-search" role="search">
    ...
    <label for="searchInput" class="sr-only" style="position:absolute;width:1px;height:1px;overflow:hidden;clip:rect(0,0,0,0)">Rechercher dans le guide</label>
    <input type="search" id="searchInput" placeholder="Rechercher une rubrique…" aria-label="Rechercher dans le guide">
  </div>
...
<div class="layout">
  ...
  <main id="content" role="main">
    ...
    <div class="hero">
      ...
      <p class="hero-sub">
        Maîtrisez la gestion RH et la paie de votre entreprise ivoirienne : des employés aux bulletins, des contrats aux déclarations CNPS, CMU et ITS. Ce guide couvre <strong>l'intégralité du logiciel</strong> avec procédures pas-à-pas, règles métier et formules de calcul conformes SYSCOHADA.
      </p>
      <div class="hero-meta">
    ...
    <section id="intro">
      ...
      <p>
        <strong>RH Flow</strong> est une solution complète de gestion des ressources humaines et de la paie, conçue pour les entreprises opérant en Côte d'Ivoire. L'application automatise l'ensemble du cycle de vie du salarié : de l'embauche à la sortie, en passant par le contrat, la paie mensuelle, les déclarations fiscales et sociales, et le pilotage des effectifs.
      </p>
      ...
      <ul>
        <li><strong>Multi-société</strong> : toutes les données sont isolées par entreprise (<code>company_id</code>). Un utilisateur ne voit jamais les données d'une autre société.</li>
        <li><strong>Quota d'abonnement</strong> : chaque plan impose un nombre maximum de salariés actifs (<code>max_employees</code>). Toute création au-delà est bloquée.</li>
        <li><strong>Exercice &amp; période actifs</strong> : la paie s'opère toujours dans le contexte d'un exercice et d'une période actifs. Aucun calcul n'est possible hors période ouverte.</li>
        <li><strong>Soft delete</strong> : la « suppression » d'un salarié désactive son compte (<code>is_active = 0</code>) sans perte d'historique paie.</li>
      </ul>
    </section>
    ...
    <section id="demarrage">
      ...
      <p>Voici le <strong>parcours recommandé</strong> pour configurer RH Flow et traiter votre première paie en moins de 2 heures.</p>
      ...
      <ol class="steps">
        <li>
          ...
          Renseignez la raison sociale, le numéro de compte contribuable (NCC), l'IDU (CNPS), l'adresse, le logo, la devise (XOF) et la couleur principale des bulletins. Ces informations apparaîtront sur tous les documents officiels.
        </li>
        <li>
          <strong>Référentiels organisationnels</strong>
          Déclarez vos <em>branches</em>, <em>services</em>, <em>postes</em> et <em>catégories professionnelles</em>. Ces référentiels sont obligatoires pour créer un salarié.
        </li>
        <li>
          <strong>Types de congés</strong>
          Configurez les motifs (annuel, maladie, maternité, exceptionnel…) avec leurs règles d'acquisition et soldes initiaux.
        </li>
        <li>
          <strong>Création des salariés</strong>
          Distinguez les <em>Mensuels</em> (salaire fixe) et les <em>Journaliers</em> (rémunération à l'heure/jour). Un compte utilisateur est créé automatiquement pour l'accès à l'espace salarié.
        </li>
        <li>
          <strong>Contrats de travail</strong>
          Associez immédiatement un contrat (CDI, CDD, Stage, Consultant) à chaque salarié après sa création. Sans contrat actif, aucune paie n'est possible.
        </li>
      </ol>

      <div class="callout success" role="note">
        <svg class="callout-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="20 6 9 17 4 12"/></svg>
        <div class="callout-body">
          <div class="callout-title">Astuce</div>
          Une fois l'onboarding terminé, vous n'aurez plus qu'à répéter le <strong>cycle mensuel de paie en 4 étapes</strong> (voir §12) chaque mois.
        </div>
      </div>
    </section>
    ...
    <section id="connexion">
      ...
      <p>
        La page de connexion accepte indifféremment une <strong>adresse email</strong> ou un <strong>nom d'utilisateur</strong>. Si la première tentative échoue, le système tente automatiquement l'autre méthode.
      </p>

      <h3>Orientation selon le profil</h3>
      <div class="table-wrap">
        <table>
          <caption style="text-align:left;padding:12px 14px;font-weight:600;color:var(--text-main)">Redirection après authentification</caption>
          <thead>
            <tr>
          ...
          <tbody>
            <tr><td><code>super_admin</code></td><td>Dashboard Super Admin</td><td>Toutes les sociétés, facturation</td></tr>
            <tr><td><code>entreprise</code> (DG)</td><td>Dashboard Entreprise</td><td>Pilotage global, paramètres</td></tr>
            <tr><td><code>hr</code> / <code>paie</code></td><td>Dashboard RH</td><td>Salariés, contrats, paie</td></tr>
            <tr><td><code>employee</code></td><td>Espace salarié</td><td>Bulletins, congés, pointage</td></tr>
          </tbody>
        </table>
      </div>
      ...
      <div class="callout info" role="note">
        ...
        <div class="callout-body">
          ...
          Mot de passe : minimum 8 caractères · Session : 30 min d'inactivité · 5 tentatives de connexion maximum avant blocage temporaire.
        </div>
      </div>
    </section>
    ...
    <section id="dashboard">
      ...
      <div class="cards">
        <div class="card">
          ...
          <p>Vision directionnelle : effectifs totaux, <strong>masse salariale</strong>, charges patronales, éléments de paie agrégés, alertes fiscales.</p>
        </div>
        <div class="card">
          <div class="card-icon" aria-hidden="true">👥</div>
          <h4>Dashboard RH</h4>
          <p>Vision opérationnelle : répartition par service, statut matrimonial, nouveaux entrants, demandes en attente.</p>
        </div>
      </div>
      ...
      <ul>
        ...
        <li><strong>Alertes</strong> : échéances fiscales (ITS, CNPS), contrats CDD arrivant à terme, anniversaires, congés en attente.</li>
      ...
      <div class="callout warning" role="note">
        ...
        <div class="callout-body">
          ...
          Un bandeau rouge apparaît dès qu'une échéance fiscale approche. Ne l'ignorez pas : des pénalités s'appliquent en cas de retard de déclaration CNPS ou ITS.
        </div>
      </div>
    </section>
    ...
    <section id="employes">
      ...
      <ol class="steps">
        <li>
          ...
          Nom, prénoms, genre, date de naissance, situation matrimoniale, nombre d'enfants, nombre de personnes à charge, statut local/expatrié. Les <strong>parts fiscales</strong> sont calculées automatiquement (voir encart ci-dessous).
        </li>
        <li>
          <strong>Données du poste</strong>
          Matricule (unique par entreprise, auto-généré au format <code>EMP{année}{mois}{séquence}</code>), branche, service, poste, catégorie, date d'embauche.
        </li>
        <li>
        ...
        <li>
          ...
          Salaire mensuel (ou horaire pour les journaliers), banque, RIB, numéro CNPS. Le <strong>taux horaire</strong> est calculé automatiquement : <code>salaire_mensuel / 173.33</code>.
        </li>
      </ol>

      <div class="callout info" role="note">
        <svg class="callout-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>
        <div class="callout-body">
          <div class="callout-title">Calcul des parts fiscales</div>
          <code>Parts = 1 + (0.5 × marié) + (0.5 × nombre d'enfants) + (0.5 × personnes à charge infirmes)</code>. Ce nombre détermine la réduction d'impôt ITS applicable.
        </div>
      </div>
      ...
      <div class="table-wrap">
        <table>
          ...
          <tbody>
            <tr><td><code>employee_id</code></td><td>Unique par entreprise</td><td>« L'ID Employé est déjà attribué. Rafraîchissez la page. »</td></tr>
            <tr><td><code>username</code></td><td>Unique global</td><td>Format <code>prenom.nom</code> avec suffixe numérique si doublon</td></tr>
            <tr><td>Effectifs</td><td>≤ <code>max_employees</code> du plan</td><td>Redirection vers la page d'abonnement</td></tr>
          </tbody>
        </table>
      </div>
      ...
      <div class="cards">
        <div class="card">
          ...
          <p>Salaire fixe mensuel, bulletin chaque fin de mois, intégré au cycle de paie standard. Typique : CDI, CDD long.</p>
        </div>
        <div class="card">
          <div class="card-icon" aria-hidden="true">⏱️</div>
          <h4>Employé Journalier</h4>
          <p>Rémunération à la journée ou à l'heure, pointage quotidien obligatoire, paie calculée sur présences réelles.</p>
        </div>
      </div>
      ...
      <div class="callout success" role="note">
        ...
        <div class="callout-body">
          ...
          Si la date de naissance est renseignée, un <strong>événement d'anniversaire</strong> est publié automatiquement. Un <strong>compte utilisateur</strong> de type <code>employee</code> est créé pour l'accès à l'espace salarié.
        </div>
      </div>
    ...
    <section id="famille-cmu">
      ...
      <ol>
        ...
        <li>Cliquez sur <em>Ajouter un membre</em> et renseignez : nom, prénoms, genre, type (conjoint, enfant, ascendant), statut CMU (<code>Oui</code> / <code>Non</code>).</li>
        <li>Si <code>CMU = Oui</code>, joignez le document justificatif (PDF, JPG, PNG — max 2 Mo).</li>
      </ol>

      <div class="callout info" role="note">
        <svg class="callout-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/></svg>
        <div class="callout-body">
          <div class="callout-title">Synchronisation automatique CMU</div>
          Lorsque <code>CMU = Oui</code>, une ligne de rattachement familial est créée dans <code>employee_cmus</code>. Si le statut repasse à <code>Non</code>, la ligne est automatiquement supprimée.
        </div>
      </div>
    ...
    <section id="contrats">
      ...
      <div class="table-wrap">
        <table>
          ...
          <tbody>
            <tr><td>CDI</td><td><code>CDI</code></td><td>Indéterminée</td><td>Aucune date de fin</td></tr>
            <tr><td>CDD</td><td><code>CDD</code></td><td>Déterminée</td><td>Date de fin + motif de recours obligatoires</td></tr>
            <tr><td>Stage</td><td><code>STAGE</code></td><td>24 mois max.</td><td>Établissement + niveau d'étude requis</td></tr>
            <tr><td>Consultant</td><td><code>CONSULT</code></td><td>Prestation</td><td>Facturation — hors déclarations CNPS salarié</td></tr>
          </tbody>
        </table>
      </div>
      ...
      <ol class="steps">
        <li>
          ...
          Sujet du contrat, salarié, type, date de début, date de fin (optionnelle, mais postérieure à la date de début).
        </li>
        <li>
        ...
        <li>
          ...
          Le statut initial est <code>accept</code>. La fiche salarié est automatiquement mise à jour avec la date d'embauche et la date de fin de relation.
        </li>
      </ol>
      ...
      <ul>
        <li><strong>Reconduction</strong> : met à jour dates, type de contrat, catégorie, poste, branche et réactive le salarié si nécessaire.</li>
        <li><strong>Modification salariale</strong> : ajuste la rémunération sans rompre le contrat.</li>
      </ul>

      <div class="callout warning" role="note">
        <svg class="callout-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M10.29 3.86 1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/></svg>
        <div class="callout-body">
          <div class="callout-title">Types de contrat non supprimables</div>
          Un type de contrat utilisé par au moins un contrat actif ou archivé ne peut pas être supprimé — seulement désactivé.
        </div>
      </div>
    </section>
    ...
    <section id="pointage">
      ...
      <div class="table-wrap">
        <table>
          ...
          <tbody>
            <tr><td>QR Code</td><td>Smartphone</td><td>Scan entrée/sortie</td><td>Automatique</td></tr>
            <tr><td>Biométrique</td><td>Pointeuse dédiée</td><td>Empreinte digitale</td><td>Automatique</td></tr>
            <tr><td>Manuel</td><td>Navigateur web</td><td>Formulaire hebdomadaire</td><td>Manager / RH</td></tr>
          </tbody>
        </table>
      </div>
      ...
      <p>
        Le tableau présente une vue semaine par semaine avec filtres par <em>employé</em>, <em>type de période</em> (semaine / quinzaine / mois) et <em>mois</em>. Chaque cellule représente un jour ouvré et peut contenir : présence, absence justifiée, absence non justifiée, congé, jour férié, repos hebdomadaire.
      </p>

      <div class="callout info" role="note">
        <svg class="callout-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="10"/></svg>
        <div class="callout-body">
          <div class="callout-title">Impact sur la paie</div>
          Les absences non justifiées entraînent une retenue sur salaire calculée au prorata temporis (<code>jours absents × salaire_journalier</code>).
        </div>
      </div>
    </section>
    ...
    <section id="conges">
      ...
      <div class="table-wrap">
        <table>
          ...
          <tbody>
            <tr><td>1</td><td>Salarié</td><td>Soumission de la demande</td><td>Solde suffisant + dates valides</td></tr>
            <tr><td>2</td><td>Manager N+1</td><td>Validation hiérarchique</td><td>Autorisation niveau 1</td></tr>
            <tr><td>3</td><td>Service RH</td><td>Validation finale</td><td>Vérification administrative + impact paie</td></tr>
          </tbody>
        </table>
      </div>
      ...
      <ul>
        <li><strong>Congé annuel</strong> : 2,2 jours ouvrés acquis par mois de présence (27 jours/an — Code du Travail ivoirien).</li>
      ...
      <div class="callout success" role="note">
        ...
        <div class="callout-body">
          ...
          Le solde de congés est recalculé chaque mois en fonction de la présence effective. Vous pouvez l'ajuster manuellement depuis la fiche salarié (onglet Congés).
        </div>
      </div>
    </section>
    ...
    <section id="heures-sup">
      ...
      <div class="table-wrap">
        <table>
          ...
          <tbody>
            <tr><td>41<sup>e</sup> à 46<sup>e</sup> heure/semaine</td><td>+15 %</td><td><code>taux_horaire × 1,15</code></td></tr>
            <tr><td>À partir de la 47<sup>e</sup> heure</td><td>+50 %</td><td><code>taux_horaire × 1,50</code></td></tr>
            <tr><td>Heures de nuit (21h–5h)</td><td>+75 %</td><td><code>taux_horaire × 1,75</code></td></tr>
            <tr><td>Dimanche &amp; jours fériés</td><td>+100 %</td><td><code>taux_horaire × 2,00</code></td></tr>
          </tbody>
        </table>
      </div>
    ...
    <section id="ruptures">
      ...
      <div class="table-wrap">
        <table>
          ...
          <tbody>
            <tr><td>Démission</td><td>Congés payés non pris</td><td>Selon ancienneté</td></tr>
            <tr><td>Licenciement économique</td><td>Indemnité légale + congés</td><td>1 à 3 mois</td></tr>
            <tr><td>Licenciement faute grave</td><td>Aucune</td><td>Non</td></tr>
            <tr><td>Fin de CDD</td><td>Indemnité de fin de contrat (si prévue)</td><td>Non</td></tr>
            <tr><td>Retraite</td><td>Indemnité de départ</td><td>Selon convention</td></tr>
          </tbody>
        </table>
      </div>
    </section>
    ...
    <section id="cycle-paie">
      ...
      <p>
        C'est le <strong>cœur opérationnel</strong> de RH Flow. Chaque mois, vous suivez un cycle en <strong>4 étapes</strong> accessibles depuis la page <em>Période en cours</em>.
      </p>
      ...
      <div class="callout warning" role="note">
        ...
        <div class="callout-body">
          ...
          Assurez-vous qu'un <strong>exercice</strong> (ex. 2026) is actif, et qu'une <strong>période</strong> (ex. Avril 2026) is ouverte. Sans cela, tous les écrans de paie sont en lecture seule.
        </div>
      </div>
      ...
      <ol class="steps">
        <li>
          ...
          Éléments constitutifs du brut : salaire de base, primes (transport, performance, responsabilité), indemnités, avantages en nature, heures supplémentaires.
        </li>
        <li>
      ...
      <p>
        Une fois les bulletins validés, la période est <strong>clôturée</strong>. Elle devient alors en lecture seule et les <strong>déclarations mensuelles</strong> (CNPS, ITS) deviennent disponibles (§17).
      </p>
    </section>
    ...
    <section id="elements-brut">
      ...
      <p>Les éléments du brut se configurent de manière <strong>globale</strong> (tous les salariés) ou <strong>individuelle</strong>.</p>
    ...
    <section id="retenues-prets">
      ...
      <ol class="steps">
        <li>
          ...
          Sélectionnez le salarié, saisissez le montant total, le nombre de mensualités, la date de premier prélèvement. Le système calcule automatiquement la mensualité.
        </li>
        <li>
        ...
        <li>
          <strong>Suivi</strong>
          L'onglet <em>Prêts</em> affiche à tout moment : capital restant dû, nombre de mensualités restantes, date de fin prévisionnelle.
        </li>
      </ol>
      ...
      <div class="callout info" role="note">
        ...
        <div class="callout-body">
          ...
          La somme des retenues volontaires ne peut excéder la <strong>quotité saisissable légale</strong> (1/10 à 1/3 du salaire selon les tranches).
        </div>
      </div>
    </section>
    ...
    <section id="calcul-bulletin">
      ...
      <ol>
        ...
        <li>Cliquez sur <strong>Lancer le calcul</strong>. Le système applique toutes les règles métier et génère les bulletins.</li>
        <li>Consultez le récapitulatif : <em>Total bruts</em>, <em>Total cotisations</em>, <em>Total nets</em>, <em>Coût employeur</em>.</li>
      </ol>

      <h3>Structure d'un bulletin</h3>
      <ul>
        <li><strong>En-tête</strong> : logo de l'entreprise, période, salarié, matricule, contrat.</li>
        <li><strong>Corps</strong> : tableau des éléments du brut, base imposable, cotisations salariales, retenues, net à payer.</li>
...
cnps_employeur = round(total_salaire_brut_soumis × 7,7) / 100</code></pre>
      ...
      <div class="table-wrap">
        <table>
          ...
          <tbody>
            <tr><td>0,02</td><td>1 500 FCFA</td></tr>
            <tr><td>0,03</td><td>2 250 FCFA</td></tr>
            <tr><td>0,04</td><td>3 000 FCFA</td></tr>
            <tr><td>0,05</td><td>3 750 FCFA</td></tr>
          </tbody>
        </table>
      </div>
...
// À partir de 7 personnes
      ...
      <div class="table-wrap">
        <table>
          ...
          <tbody>
            <tr><td>0 — 75 000</td><td>0 %</td></tr>
            <tr><td>75 001 — 240 000</td><td>16 %</td></tr>
            <tr><td>240 001 — 800 000</td><td>21 %</td></tr>
            <tr><td>800 001 — 2 400 000</td><td>24 %</td></tr>
            <tr><td>2 400 001 — 8 000 000</td><td>28 %</td></tr>
            <tr><td>Plus de 8 000 000</td><td>32 %</td></tr>
          </tbody>
        </table>
      </div>
      ...
      <div class="table-wrap">
        <table>
          ...
          <tbody>
            <tr><td>1 part</td><td>0 FCFA</td></tr>
            <tr><td>1,5 part</td><td>5 500 FCFA</td></tr>
            <tr><td>2 parts</td><td>11 000 FCFA</td></tr>
            <tr><td>2,5 parts</td><td>16 500 FCFA</td></tr>
            <tr><td>3 parts</td><td>22 000 FCFA</td></tr>
            <tr><td>Plus de 3 parts</td><td>+5 500 FCFA par demi-part</td></tr>
          </tbody>
        </table>
      </div>
...
// 173,33 = 40 heures × 52 semaines / 12 mois</code></pre>
    ...
    <section id="declarations-mensuelles">
      ...
      <div class="cards">
        <div class="card">
          <div class="card-icon" aria-hidden="true">🏥</div>
          <h4>CNPS</h4>
          <p>Déclaration mensuelle des cotisations sociales. Export au format officiel, à déposer avant le <strong>15 du mois suivant</strong>.</p>
        </div>
        <div class="card">
          <div class="card-icon" aria-hidden="true">📊</div>
          <h4>ITS / DGI</h4>
          <p>Déclaration d'Impôt sur Traitements et Salaires. Dépôt avant le <strong>15 du mois suivant</strong> à la DGI.</p>
        </div>
        <div class="card">
          <div class="card-icon" aria-hidden="true">⚕️</div>
          <h4>CMU</h4>
      ...
      <div class="callout warning" role="note">
        ...
        <div class="callout-body">
          ...
          Tout retard de déclaration entraîne des pénalités calculées sur les montants dus. Configurez les rappels automatiques depuis <em>Paramètres → Notifications</em>.
        </div>
      </div>
    </section>
    ...
    <section id="parametres">
      ...
      <ul>
        ...
        <li>Couleur principale des bulletins (optez pour une teinte <strong>à fort contraste</strong> pour garantir la lisibilité à l'impression)</li>
      ...
      <div class="table-wrap">
        <table>
          ...
          <tbody>
            <tr><td>Longueur minimale du mot de passe</td><td>8 caractères</td></tr>
            <tr><td>Timeout de session</td><td>30 minutes d'inactivité</td></tr>
            <tr><td>Tentatives de connexion</td><td>5 maximum</td></tr>
            <tr><td>Format email accepté</td><td><code>^[\w\.-]+@[\w\.-]+\.[a-zA-Z]{2,}$</code></td></tr>
            <tr><td>Format téléphone</td><td><code>^\+225[0-9]{8}$</code></td></tr>
            <tr><td>Montant maximum</td><td>999 999 999 FCFA</td></tr>
          </tbody>
        </table>
      </div>
    ...
    <section id="assistant">
      ...
      <div class="callout info" role="note">
        ...
        <div class="callout-body">
          ...
          L'assistant utilise uniquement les données de votre société ; aucune information ne sort du périmètre de votre entreprise.
        </div>
      </div>
    </section>
    ...
    <section id="faq">
      ...
      <details>
        ...
        <p>Votre plan d'abonnement impose un <code>max_employees</code>. Passez à un plan supérieur depuis <em>Paramètres → Abonnement</em>, ou désactivez un salarié inactif depuis la fiche employé.</p>
      </details>

      <details>
        <summary>Pourquoi le calcul de paie me renvoie « Exercice non actif » ?</summary>
        <p>Vous devez d'abord créer l'exercice annuel (ex. 2026) et le marquer comme actif depuis <em>Gestion de paie → Listing des exercices</em>. Puis créez une période mensuelle dans cet exercice.</p>
      </details>

      <details>
        <summary>Les montants du bulletin semblent incorrects</summary>
        <p>Vérifiez dans l'ordre : (1) le salaire de base contractuel, (2) les éléments du brut affectés pour la période, (3) les parts fiscales du salarié, (4) les retenues volontaires en cours (prêts, acomptes). Un recalcul force la prise en compte de toutes les modifications.</p>
      </details>

      <details>
        <summary>Un salarié n'apparaît pas dans le cycle de paie</summary>
        <p>Deux causes possibles : (1) il n'a pas de contrat actif couvrant la période — vérifiez les dates du contrat ; (2) il est désactivé (<code>is_active = 0</code>) — réactivez-le depuis la fiche.</p>
      </details>

      <details>
        <summary>Comment corriger un bulletin déjà validé ?</summary>
        <p>Si la période n'est pas clôturée, vous pouvez modifier les éléments et relancer le calcul. Si la période est clôturée, créez un élément de <em>rappel</em> sur la période suivante pour régulariser.</p>
      </details>

      <details>
        <summary>Le salarié ne reçoit pas son bulletin par email</summary>
        <p>Vérifiez l'adresse email dans la fiche salarié, puis que l'email d'envoi automatique est activé dans <em>Paramètres → Notifications</em>. Consultez les logs d'envoi pour identifier un éventuel rejet.</p>
      </details>

      <details>
        <summary>Comment gérer un salarié qui travaille sur plusieurs sites ?</summary>
        <p>RH Flow ne permet actuellement qu'un seul rattachement <em>branche/service/poste</em> par salarié. Pour une mobilité inter-sites, créez un avenant lors du transfert.</p>
      </details>

      <details>
        <summary>Puis-je importer mes salariés en masse depuis Excel ?</summary>
        <p>Oui, depuis <em>Gestion des employés → Importer</em>. Téléchargez le modèle Excel, remplissez-le, puis importez-le. Les erreurs de validation sont signalées ligne par ligne.</p>
      </details>
    </section>
    ...
    <section id="support">
      ...
      <div class="cards">
        ...
        <div class="card">
          ...
          <p>Tutoriels vidéo, articles pratiques et cas d'usage sur <a href="https://rhflow.dc-knowing.com/aide">rhflow.dc-knowing.com/aide</a>.</p>
        </div>
      </div>
      ...
      <div class="callout success" role="note">
        ...
        <div class="callout-body">
          ...
          RH Flow est conforme aux normes comptables OHADA et au Code du Travail ivoirien. Les mises à jour fiscales sont intégrées automatiquement.
        </div>
      </div>
    </section>
