    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div>
                    <a href="{{ route('company.paiesalaries.exercices.create') }}" class="btn btn-primary" id="guide-btn-new-exercice">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h3 class="card-title mb-0">{{ number_format($stats['masse_salariale_mensuelle'], 0, ',', ' ') }} FCFA</h3>
                        </div>
                        <div class="avatar">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h3 class="card-title mb-0">{{ number_format($stats['total_pret_en_cours'], 0, ',', ' ') }} FCFA</h3>
                        </div>
                        <div class="avatar">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h3 class="card-title mb-0">{{ number_format($stats['salaire_moyen'], 0, ',', ' ') }} FCFA</h3>
                        </div>
                        <div class="avatar">
        ...
        <div class="col-12 col-lg-8 mb-4">
            <div class="card h-100">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div class="dropdown">
                        <button class="btn p-0" type="button" id="salesReportTabs" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <div class="col-12 col-lg-4 mb-4">
            <div class="card h-100">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('company.paiesalaries.exercices.create') }}" class="btn btn-sm btn-outline-primary">Tout voir</a>
                </div>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <small class="text-muted">{{ date('M Y', strtotime($paie->periode)) }}</small>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="text-end">
                                        <span class="fw-semibold">{{ number_format($paie->salaire_net, 0, ',', ' ') }} FCFA</span>
                                    </td>
                                </tr>
                                @empty
                                <tr>
                                ...
                                <tr>
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <small class="ms-2 text-muted">{{ round($pret->repayment_percentage ?? 0) }}%</small>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="text-end">
                                        <div class="d-flex flex-column">
                                            <span class="fw-semibold">{{ number_format($pret->next_payment['amount'] ?? $pret->amount_deduc, 0, ',', ' ') }} FCFA</span>
                                            <small class="text-muted">
                                                Reste : {{ number_format($pret->remaining_amount ?? $pret->amount, 0, ',', ' ') }} FCFA
                                            </small>
                                        </div>
                                    </td>
                                </tr>
                    ...
                    <div class="row g-3">
                        <div class="col-6">
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <span class="ms-auto fw-semibold">{{ number_format($stats['masse_salariale_mensuelle'] - $stats['total_primes_mois'], 0, ',', ' ') }} FCFA</span>
                            </div>
                            <div class="d-flex align-items-center mb-2">
                                <span class="badge bg-label-success me-2" style="width: 12px; height: 12px;"></span>
                                <span>Primes</span>
                                <span class="ms-auto fw-semibold">{{ number_format($stats['total_primes_mois'], 0, ',', ' ') }} FCFA</span>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <span>Retenues</span>
                                <span class="ms-auto fw-semibold">{{ number_format($stats['total_retenues_mois'], 0, ',', ' ') }} FCFA</span>
                            </div>
                            <div class="d-flex align-items-center mb-2">
                                <span class="badge bg-label-info me-2" style="width: 12px; height: 12px;"></span>
                                <span>Cotisations</span>
                                <span class="ms-auto fw-semibold">{{ number_format(($stats['masse_salariale_mensuelle'] * 0.1), 0, ',', ' ') }} FCFA</span>
                            </div>
                        </div>
                    </div>
                </div>
