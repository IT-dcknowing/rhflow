<form id="editRetenueForm" action="{{ route('company.paiesalaries.remboursements.update', $retenue->id) }}" method="POST">
    @csrf
    @method('PUT')
    <div class="row">
        ...
        <div class="col-md-12 mb-4">
            <div class="form-group">
                ...
                <input type="hidden" name="salariale" id="salariale" value="{{ $retenue->salariale }}">                       
            </div>
        </div>
