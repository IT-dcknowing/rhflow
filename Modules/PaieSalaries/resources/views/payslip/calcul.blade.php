        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h4 class="mb-1"> Configuration des paies mensuelles @if($periode) - Exercice :
        ...
        @if($periode)
            <div class="card">
                <div class="card-header">
                    <h5> Prévisualisation de la paie mensuelle @if($periode) - Période :
                    ...
                    <div class="alert alert-warning">
                        <strong>Prévisualisation :</strong> Consultez la paie mensuelle pour <b>tous les employés mensuels du
                            mois sélectionné</b>. Vous pouvez vérifier les détails avant de procéder au traitement effectif de
                        la paie.
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <div class="mb-3 d-flex justify-content-between align-items-center">
                        <div class="d-flex align-items-center gap-3">
                            <input type="text" id="previous-search" class="form-control" style="width: 300px;"
                                placeholder="Rechercher un employé mensuel...">
                        </div>
                                ...
                                @forelse($employees as $listemp)
                                    @if($listemp->is_active == 1)
                                        <tr>
                                            ...
                                            <td align="right">
                                                Prêt: {{ number_format($listemp->get_loan_retenue($periode->id), 0, '.', ' ') }} FCFA
                                                <br>
                                                A. Retenue: {{ number_format($listemp->get_Autre_retenue($periode->id), 0, '.', ' ') }}
                                                FCFA <br>
                                                Remboursement:
                                                {{ number_format($listemp->get_Rembourssement($periode->id), 0, '.', ' ') }} FCFA
                                            </td>
                                            <td class="net-salary" align="right">
                                                <strong class="badge rounded bg-label-black p-1"
                                            ...
                                            <td class="text-center">
                                                ...
                                                <div class="dropdown-menu">
                                                    ...
                                                    <a class="dropdown-item align-items-center btn-add-elements" href="#"
                                                        data-bs-toggle="modal" data-bs-size="xl" data-bs-target="#addElementsModal"
                                                        data-employee-id="{{ $listemp->id }}" data-employee-name="{{ $listemp->name }}"
                                                        data-periode-id="{{ $periode->id }}">
                                                    ...
                                                    <a class="dropdown-item align-items-center btn-show-elements" href="#"
                                                        data-bs-toggle="modal" data-bs-size="xl" data-bs-target="#showElementsModal"
                                                        data-employee-id="{{ $listemp->id }}" data-employee-name="{{ $listemp->name }}"
                                                        data-periode-id="{{ $periode->id }}">
                                                    ...
                                                    <a class="dropdown-item align-items-center btn-edit-elements" href="#"
                                                        data-bs-toggle="modal" data-bs-size="xl" data-bs-target="#editElementsModal"
                                                        data-employee-id="{{ $listemp->id }}" data-employee-name="{{ $listemp->name }}"
                                                        data-periode-id="{{ $periode->id }}">
                                                    ...
                                                    <a href="#"
                                                        class="dropdown-item align-items-center bg-label-info btn-aperçu-bulletin"
                                                        data-bs-toggle="modal" data-bs-size="xl" data-bs-target="#showBulletinModal"
                                                        data-employee-id="{{ $listemp->id }}" data-employee-name="{{ $listemp->name }}"
                                                        data-exercice-id="{{ $periode->exercice->id }}"
                                                        data-periode-id="{{ $periode->id }}">
