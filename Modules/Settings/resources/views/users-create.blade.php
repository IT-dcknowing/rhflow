...
<div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <form method="POST" action="{{ route('company.settings.users.store') }}" id="createUserForm">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" name="name" required oninput="generateProposal()"
                                       id="name" placeholder="Ex: Jean Dupont" value="{{ old('name') }}">
                                @error('name')
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="send_welcome_email" value="1" id="sendWelcomeEmail">
    ...
    <div class="row mt-4" id="previewSection" style="display: none;">
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">👁️ Aperçu de l'Utilisateur</h5>
                ...
                <div class="card-body">
                    ...
                    <div class="alert alert-info">
                        ...
                        <strong>Information:</strong> L'utilisateur recevra un email avec ses identifiants de connexion une fois créé.
                    </div>
                </div>
            </div>
        </div>
