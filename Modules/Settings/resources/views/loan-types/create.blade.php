...
@section('title', 'Créer un Type de Prêt - RH Flow')
        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-muted mb-0">Configurez un nouveau type de prêt pour les employés</p>
        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('company.settings.loan-types.store') }}" id="loanTypeForm">
                        @csrf
                        ...
                        <div class="form-section">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror" 
                                          ...
                                          name="description" 
                                          rows="3"
                                          placeholder="Description détaillée du type de prêt...">{{ old('description') }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" 
                                           ...
                                           value="{{ old('repayment_period_min', 1) }}" 
                                           placeholder="1"
                                           min="1"
                                           required>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" 
                                           ...
                                           value="{{ old('repayment_period_max', 12) }}" 
                                           placeholder="12"
                                           min="1"
                                           required>
                        ...
                        <div class="form-section">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="d-flex align-items-center">
                                    <label class="switch">
                                        <input type="checkbox" name="requires_guarantor" value="1" id="requires_guarantor" {{ old('requires_guarantor') ? 'checked' : '' }}>
                                        <span class="slider"></span>
                                    </label>
                            ...
                            <div class="mb-3" id="guarantor_conditions_section" style="display: none;">
                                ...
                                <textarea class="form-control @error('guarantor_conditions') is-invalid @enderror" 
                                          ...
                                          rows="3"
                                          placeholder="Décrivez les conditions de garantie requises...">{{ old('guarantor_conditions') }}</textarea>
        ...
        <div class="col-lg-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <h6 class="text-primary">Montant Maximum</h6>
                        <p class="text-muted small">Le montant maximum qu'un employé peut emprunter avec ce type de prêt.</p>
                    </div>
                    <div class="mb-3">
                        <h6 class="text-primary">Taux d'Intérêt</h6>
                        <p class="text-muted small">Le taux d'intérêt annuel appliqué au prêt. Ex: 5.5 pour 5.5%.</p>
                    </div>
                    <div class="mb-3">
                        <h6 class="text-primary">Période de Remboursement</h6>
                        <p class="text-muted small">La durée minimale et maximale en mois pour rembourser le prêt.</p>
                    </div>
                    <div class="mb-3">
                        <h6 class="text-primary">Garantie Requise</h6>
                        <p class="text-muted small">Indiquez si ce type de prêt nécessite une garantie ou un garant.</p>
                    </div>
                </div>
            </div>
        </div>
