...
<div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="col-xl-4 col-lg-6 mb-4">
            <div class="card h-100">
                ...
                <div class="card-body text-center">
                    <div class="mb-3">
                        @if($company->logo)
                            <img src="{{ url($company->logo_url) }}" alt="Logo" class="img-fluid mb-3" style="max-height: 120px; border-radius: 8px;">
                    ...
                    <form method="POST" action="{{ route('company.settings.logo.update') }}" enctype="multipart/form-data" class="d-inline-block w-100">
                        @csrf
                        <div class="mb-3">
                            <input type="file" class="form-control" name="logo" accept="image/*" required style="display: none;" id="logoInput" onchange="previewLogo(this)">
                            <button type="button" class="btn btn-outline-primary w-100 mb-2" onclick="document.getElementById('logoInput').click()">
                                <i class="fas fa-upload me-1"></i>{{ $company->logo ? 'Changer le Logo' : 'Uploader le Logo' }}
                            </button>
                    ...
                    <div id="logoPreview" class="mt-2" style="display: none;">
                        ...
                        <br>
                        <img id="logoPreviewImg" src="" alt="Aperçu" class="img-fluid mt-1" style="max-height: 60px; border-radius: 4px;">
                    </div>
        ...
        <div class="col-xl-4 col-lg-6 mb-4">
            <div class="card h-100">
                ...
                <div class="card-body text-center">
                    <div class="mb-3">
                        @if($company->electronic_signature)
                            <img src="{{url($company->electronic_signature_url) }}" alt="Signature" class="img-fluid mb-3" style="max-height: 120px; border-radius: 8px;">
                            <div class="d-flex justify-content-center mb-3">
                    ...
                    <form method="POST" action="{{ route('company.settings.signature.update') }}" enctype="multipart/form-data" class="d-inline-block w-100">
                        @csrf
                        <div class="mb-3">
                            <input type="file" class="form-control" name="signature" accept="image/*" required style="display: none;" id="signatureInput" onchange="previewSignature(this)">
                            <button type="button" class="btn btn-outline-info w-100 mb-2" onclick="document.getElementById('signatureInput').click()">
                                <i class="fas fa-upload me-1"></i>{{ $company->electronic_signature ? 'Changer la Signature' : 'Uploader la Signature' }}
                            </button>
                    ...
                    <div id="signaturePreview" class="mt-2" style="display: none;">
                        <small class="text-muted">Aperçu:</small>
                        <br>
                        <img id="signaturePreviewImg" src="" alt="Aperçu" class="img-fluid mt-1" style="max-height: 60px; border-radius: 4px;">
                    </div>
        ...
        <div class="col-xl-4 col-lg-12 mb-4">
            <div class="card h-100">
                ...
                <div class="card-body text-center">
                    <div class="mb-3">
                        @if($company->electronic_stamp)
                            <img src="{{ url($company->electronic_stamp_url) }}" alt="Cachet" class="img-fluid mb-3" style="max-height: 120px; border-radius: 8px;">
                            <div class="d-flex justify-content-center mb-3">
                    ...
                    <form method="POST" action="{{ route('company.settings.stamp.update') }}" enctype="multipart/form-data" class="d-inline-block w-100">
                        @csrf
                        <div class="mb-3">
                            <input type="file" class="form-control" name="stamp" accept="image/*" required style="display: none;" id="stampInput" onchange="previewStamp(this)">
                            <button type="button" class="btn btn-outline-warning w-100 mb-2" onclick="document.getElementById('stampInput').click()">
                                <i class="fas fa-upload me-1"></i>{{ $company->electronic_stamp ? 'Changer le Cachet' : 'Uploader le Cachet' }}
                            </button>
                    ...
                    <div id="stampPreview" class="mt-2" style="display: none;">
                        <small class="text-muted">Aperçu:</small>
                        <br>
                        <img id="stampPreviewImg" src="" alt="Aperçu" class="img-fluid mt-1" style="max-height: 60px; border-radius: 4px;">
                    </div>
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">⚙️ Gestion Avancée</h5>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-4">
                            <h6 class="mb-3">📊 Statut des Documents</h6>
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                <span>Logo d'entreprise:</span>
                                <span class="{{ $company->logo ? 'text-success' : 'text-warning' }}">
                                    {{ $company->logo ? '✅ Configuré' : '⚠️ Manquant' }}
                                </span>
                            </div>
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                <span>Signature électronique:</span>
                                <span class="{{ $company->electronic_signature ? 'text-success' : 'text-muted' }}">
                                    {{ $company->electronic_signature ? '✅ Configurée' : '➖ Optionnel' }}
                                </span>
                            </div>
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                <span>Cachet électronique:</span>
                                <span class="{{ $company->electronic_stamp ? 'text-success' : 'text-muted' }}">
                                    {{ $company->electronic_stamp ? '✅ Configuré' : '➖ Optionnel' }}
                                </span>
                            </div>

                            <div class="progress mt-3" style="height: 8px;">
                                <div class="progress-bar bg-success" style="width: {{ (($company->logo ? 1 : 0) + ($company->electronic_signature ? 1 : 0) + ($company->electronic_stamp ? 1 : 0)) * 33 }}%"></div>
                            </div>
                            <small class="text-muted mt-1 d-block">
                                Complétion: {{ (($company->logo ? 1 : 0) + ($company->electronic_signature ? 1 : 0) + ($company->electronic_stamp ? 1 : 0)) }}/3 documents
                            </small>
                        </div>

                        <!-- Actions de Gestion -->
                        <div class="col-md-6 mb-4">
                            <h6 class="mb-3">🔧 Actions de Gestion</h6>

                            <div class="d-grid gap-2">
                                <button class="btn btn-outline-primary" onclick="downloadAllDocuments()">
                                    <i class="fas fa-download me-1"></i>Télécharger Tous les Documents
                                </button>

                                <button class="btn btn-outline-info" onclick="previewAllDocuments()">
                                    <i class="fas fa-eye me-1"></i>Aperçu de Tous les Documents
                                </button>

                                <button class="btn btn-outline-warning" onclick="resetAllDocuments()">
                                    <i class="fas fa-trash me-1"></i>Supprimer Tous les Documents
                                </button>

                                <div class="border-top pt-2 mt-2">
                                    <small class="text-muted d-block mb-2">Upload Multiple:</small>
                                    <form method="POST" action="{{ route('company.settings.documents.update') }}" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row g-2">
                                            <div class="col-4">
                                                <input type="file" class="form-control form-control-sm" name="logo" accept="image/*" id="bulkLogo">
                                                <small class="text-muted">Logo</small>
                                            </div>
                                            <div class="col-4">
                                                <input type="file" class="form-control form-control-sm" name="signature" accept="image/*" id="bulkSignature">
                                                <small class="text-muted">Signature</small>
                                            </div>
                                            <div class="col-4">
                                                <input type="file" class="form-control form-control-sm" name="stamp" accept="image/*" id="bulkStamp">
                                                <small class="text-muted">Cachet</small>
                                            </div>
                                        </div>
                                        <button type="submit" class="btn btn-sm btn-primary mt-2 w-100">
                                            <i class="fas fa-upload me-1"></i>Uploader Tout
                                        </button>
                                    </form>
                                </div>
                            </div>
                    ...
                    @if($companyDocuments->count() > 0)
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-lg-6 mb-4">
                                <div class="card border h-100 {{ $document->is_verified ? 'border-success' : 'border-warning' }}" data-document-id="{{ $document->id }}" data-document='@json($document->toArray())'>
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-start mb-3">
                                            <div class="d-flex align-items-center">
                                                <div class="avatar avatar-sm me-3" style="width: 40px; height: 40px;">
                                                    <div class="avatar-initial {{ $document->status_class === 'success' ? 'bg-label-success' : ($document->status_class === 'warning' ? 'bg-label-warning' : 'bg-label-secondary') }} rounded">
                                                        <i class="fas fa-{{ $document->document_type === 'statuts' ? 'file-contract' : ($document->document_type === 'rccm' ? 'building' : ($document->document_type === 'dfe' ? 'file-invoice' : ($document->document_type === 'cnps' ? 'users' : ($document->document_type === 'inspection' ? 'clipboard-check' : 'file-alt')))) }} fa-20px"></i>
                                                    </div>
                                                </div>
                                                <div>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li><a class="dropdown-item" href="{{url('/company/settings/company-documents/legal/'.$document->id.'/download')}}">
                                                        <i class="fas fa-download me-1"></i>Télécharger
                                                    </a></li>
                                                    <li><a class="dropdown-item" href="#" onclick="editDocument({{ $document->id }})">
                                                        <i class="fas fa-edit me-1"></i>Modifier
                                                    </a></li>
                                                    <li><a class="dropdown-item {{ $document->is_verified ? 'text-warning' : 'text-success' }}" href="#" onclick="toggleDocumentVerification({{ $document->id }})">
                                                        <i class="fas fa-{{ $document->is_verified ? 'times-circle' : 'check-circle' }} me-1"></i>{{ $document->is_verified ? 'Déverifier' : 'Vérifier' }}
                                                    </a></li>
                                                    <li><hr class="dropdown-divider"></li>
                                                    <li><a class="dropdown-item text-danger" href="#" onclick="deleteDocument({{ $document->id }}, '{{ $document->document_name }}')">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            @if($document->expiry_date)
                                                <div class="d-flex align-items-center mb-2">
                                                    <i class="fas fa-calendar-alt me-2 {{ $document->isExpired() ? 'text-danger' : ($document->isExpiringSoon() ? 'text-warning' : 'text-success') }}"></i>
                                                    <small class="{{ $document->isExpired() ? 'text-danger' : ($document->isExpiringSoon() ? 'text-warning' : 'text-success') }}">
                                            ...
                                            <div class="d-flex align-items-center mb-2">
                                                ...
                                                <small class="text-muted">{{ $document->formatted_file_size }} • {{ $document->file_name }}</small>
                                            </div>
                                        </div>

                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                <span class="badge {{ $document->is_verified ? 'bg-label-success' : 'bg-label-warning' }}">
                    ...
                    <div class="alert alert-warning">
                        ...
                        <ul class="mb-0 mt-2">
                            @foreach($documentStats['missing_required'] as $missingType)
                                <li>{{ \Modules\Settings\Models\CompanyDocument::DOCUMENT_TYPES[$missingType] ?? ucfirst($missingType) }}</li>
                            @endforeach
                        </ul>
                    </div>
                    @endif 
                                ...
                                <div class="flex-grow-1">
                                    <div class="d-flex justify-content-between align-items-start">
                                        <div>
                                            ...
                                            <p class="text-muted mb-0">Signature numérique configurée pour les documents officiels</p>
                                        </div>
                                        <small class="text-muted">Il y a {{ $company->updated_at->diffForHumans() }}</small>
                                    </div>
                                </div>
    ...
    <div class="modal fade" id="addDocumentModal" tabindex="-1">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form method="POST" action="{{ route('company.settings.company-documents.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" name="document_name" required placeholder="Ex: Statuts de l'entreprise 2024">
                            </div>
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Description</label>
                            <textarea class="form-control" name="description" rows="2" placeholder="Description du document..."></textarea>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="is_required" id="isRequired" value="1">
                        ...
                        <div class="mb-3" id="verificationNotes" style="display: none;">
                            ...
                            <textarea class="form-control" name="verification_notes" rows="2" placeholder="Notes sur la vérification du document..."></textarea>
                        </div>
                    </div>
                ...
                <form method="POST" action="" id="editDocumentForm" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Nom du Document *</label>
                                <input type="text" class="form-control" name="document_name" id="edit_document_name" required>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" class="form-control" name="file" accept=".pdf,.jpg,.jpeg,.png,.doc,.docx">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="is_verified" id="edit_is_verified" value="1">
                        ...
                        <div class="mb-3" id="edit_verification_notes_container" style="display: none;">
                            <label class="form-label">Notes de Vérification</label>
                            <textarea class="form-control" name="verification_notes" id="edit_verification_notes" rows="2"></textarea>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Annuler</button>
