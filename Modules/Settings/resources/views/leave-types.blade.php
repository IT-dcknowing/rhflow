        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card h-100">
                <div class="card-body text-center">
                    ...
                    <h3 class="mb-1 text-success">{{ $leaveTypes->where('is_active', true)->count() }}</h3>
                    <p class="text-muted mb-2">Types Actifs</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card h-100">
                <div class="card-body text-center">
                    ...
                    <h3 class="mb-1 text-info">{{ $leaveTypes->sum('days') }}</h3>
                    <p class="text-muted mb-2">Jours Total</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card h-100">
                <div class="card-body text-center">
                    ...
                    <h3 class="mb-1 text-warning">{{ $leaveTypes->avg('days') ? round($leaveTypes->avg('days')) : 0 }}</h3>
                    <p class="text-muted mb-2">Jours Moyens</p>
                </div>
            </div>
        </div>
                ...
                <div class="card-body text-center">
                    <div class="avatar mx-auto mb-3" style="width: 60px; height: 60px;">
                        <div class="avatar-initial bg-label-secondary rounded">
                            <i class="fas fa-percentage fa-28px"></i>
                        </div>
                    </div>
                    <h3 class="mb-1 text-secondary">{{ $leaveTypes->count() }}</h3>
                    <p class="text-muted mb-2">Types Totaux</p>
                </div>
            </div>
        </div>
    </div>
...
<div class="col-xl-4 col-lg-6 mb-4">
    <div class="card border h-100 {{ $leaveType->is_active ? 'border-success' : 'border-secondary' }}">
        <div class="card-body">

            <div class="d-flex justify-content-between align-items-start mb-3">
                <div class="d-flex align-items-center">
                    <div class="avatar avatar-sm me-3" style="width: 40px; height: 40px;">
                        <div class="avatar-initial {{ $leaveType->is_active ? 'bg-label-success' : 'bg-label-secondary' }} rounded">
                            <i class="fas fa-calendar-alt fa-20px"></i>
                        </div>
                    </div>
                    <div>
                        <h6 class="mb-1">{{ $leaveType->title }}</h6>
                        <small class="text-muted">{{ $leaveType->full_title }}</small>
                    </div>
                </div>

                <!-- DROPDOWN (structure IDENTIQUE) -->
                <div class="dropdown">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <span class="badge {{ $leaveType->is_active ? 'bg-label-success' : 'bg-label-secondary' }}">
                        {{ $leaveType->is_active ? '✅ Actif' : '❌ Inactif' }}
                    </span>
                </div>
                <div class="text-end">
                    <h5 class="mb-0 text-primary">{{ $leaveType->days }}</h5>
                    <small class="text-muted">jours</small>
                </div>
            </div>

            <div class="progress mt-3" style="height: 6px;">
                <div class="progress-bar {{ $leaveType->is_active ? 'bg-success' : 'bg-secondary' }}"
                     style="width: {{ min(100, ($leaveType->days / 30) * 100) }}%">
                </div>
            </div>
