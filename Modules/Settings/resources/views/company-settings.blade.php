                    ...
                    <div class="col-xl-8 col-lg-8 mb-4">
                            ...
                            <div class="card-body"> 
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        @if($company->employee_prefix)
                                            <input type="text" class="form-control" name="employee_prefix" value="{{ $company->employee_prefix }}">
                                        @else
                                            <input type="text" class="form-control" name="employee_prefix" value="#{{ substr($company->name, 0, 4) }}-EMP">
                                        @endif
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="postal_code" value="{{ $company->postal_code }}">
                                    </div>
                                    <div class="col-md-4 mb-3">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label">Taille de l'entreprise <span class="text-danger">*</span></label>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label">Taux d'accident de travail (CNPS) <span class="text-danger">*</span></label>
                                        <select class="form-select @error('accident_taux') is-invalid @enderror" name="accident_taux" required>
                                            <option value="">Choisir le taux...</option>
                                            <option value="0,02" {{ old('accident_taux', $company->accident_taux) == '0,02' ? 'selected' : '' }}>2%</option>
                                            <option value="0,03" {{ old('accident_taux', $company->accident_taux) == '0,03' ? 'selected' : '' }} selected>3%</option>
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <select class="form-select @error('industry') is-invalid @enderror" name="industry" required>
                                            <option value="">Choisir un secteur...</option>
                                            @foreach($sectors as $sector)
                                                <option value="{{ $sector->slug }}" {{ old('industry', $company->industry) == $sector->slug ? 'selected' : '' }}>{{ $sector->name }}</option>
                                            @endforeach
                                        </select>
                                        @error('industry')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label">Heures de travail par semaine <span class="text-danger">*</span></label>
                                        <input type="number" class="form-control" name="working_hours_per_week"
                                            value="{{ old('working_hours_per_week', $company->working_hours_per_week) }}" min="1" max="168">
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label">Jours travaillés par semaine <span class="text-danger">*</span></label>
                                        <input type="number" class="form-control" name="working_days_per_week"
                                            value="{{ old('working_days_per_week', $company->working_days_per_week) }}" min="1" max="7">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label">N° Compte Contribuable <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" name="tax_id"
                                            value="{{ old('tax_id', $company->tax_id) }}" maxlength="8" placeholder="9727498F">
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label">N° RCCM <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" name="registration_number"
                                            value="{{ old('registration_number', $company->registration_number) }}" placeholder="CI-ABJ-03-2023-B13-00452">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-4 col-lg-4 mb-4">
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <select class="form-select" name="timezone">
                                            ...
                                            <option value="Africa/Abidjan" {{ old('timezone', $company->timezone) == 'Africa/Abidjan' ? 'selected' : '' }}>Africa/Abidjan (GMT+0)</option>
                                            <option value="Europe/Paris" {{ old('timezone', $company->timezone) == 'Europe/Paris' ? 'selected' : '' }}>Europe/Paris (GMT+1)</option>
                                            <option value="Europe/London" {{ old('timezone', $company->timezone) == 'Europe/London' ? 'selected' : '' }}>Europe/London (GMT+0)</option>
                                            <option value="America/New_York" {{ old('timezone', $company->timezone) == 'America/New_York' ? 'selected' : '' }}>America/New_York (GMT-5)</option>
                                            <option value="America/Montreal" {{ old('timezone', $company->timezone) == 'America/Montreal' ? 'selected' : '' }}>America/Montreal (GMT-5)</option>
                                            <option value="Asia/Tokyo" {{ old('timezone', $company->timezone) == 'Asia/Tokyo' ? 'selected' : '' }}>Asia/Tokyo (GMT+9)</option>
                                        </select>
                                    </div>
                                    <div class="col-md-12 mb-3">
                                ...
                                <input type="hidden" name="longitude" value="{{ old('longitude', $company->longitude) }}">
                                <input type="hidden" name="location_data" value="{{ old('location_data', $company->location_data) }}">
                            </div>
                        </div>
                        ...
                        <div class="card mt-3">
                            <div class="card-header">
                                <h6 class="mb-0">👁️ Aperçu du Thème du bulletin</h6>
                            </div>
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-2">
                                    <div class="badge me-2" style="background-color: {{ $company->getThemePrimaryColor() }}; color: white;">
                                        Primaire
                                    </div>
                                    <small class="text-muted">{{ $company->getThemePrimaryColor() }}</small>
                                </div>
                                <div class="d-flex align-items-center mb-2">
                                    <div class="badge me-2" style="background-color: {{ $company->getThemeSecondaryColor() }}; color: white;">
                                        Secondaire
                                    </div>
                                    <small class="text-muted">{{ $company->getThemeSecondaryColor() }}</small>
                                </div>
                                <div class="d-flex align-items-center">
                                    <div class="badge me-2" style="background-color: {{ $company->getThemeHeaderBgColor() }}; color: {{ $company->getThemeHeaderBgColor() == '#ffffff' ? 'black' : 'white' }};">
                                        Header
                                    </div>
            ...
            <div class="card">
                ...
                <div class="card-body text-center">
                    <div class="mb-3 d-flex justify-content-center align-items-center">
                        @if($company->logo)
                            <div>
                                <img src="{{ url($company->logo_url) }}" alt="Logo" class="img-fluid mb-2" style="max-height: 100px;">
                                <small class="text-muted d-block">{{ basename($company->logo) }}</small>
                            </div>
                        @else
                            <div class="avatar avatar-xl mb-3" style="width: 80px; height: 80px;">
                                <div class="avatar-initial bg-label-secondary rounded" style="align-items: center; justify-content: center;">
                    ...
                    <form method="POST" action="{{ route('company.settings.logo.update') }}" enctype="multipart/form-data" class="d-inline">
                        @csrf
                        <div class="mb-3">
                            <input type="file" class="form-control" name="logo" accept="image/*" required style="display: none;" id="logoInput">
                ...
                <div class="card-body text-center">
                    <div class="mb-3 d-flex justify-content-center align-items-center">
                        @if($company->electronic_signature)
                            <div>
                                <img src="{{ url($company->electronic_signature_url) }}" alt="Signature" class="img-fluid mb-2" style="max-height: 100px;">
                    ...
                    <form method="POST" action="{{ route('company.settings.signature.update') }}" enctype="multipart/form-data" class="d-inline">
                        @csrf
                        <div class="mb-3">
                            <input type="file" class="form-control" name="signature" accept="image/*" required style="display: none;" id="signatureInput">
                            <button type="button" class="btn btn-outline-primary" onclick="document.getElementById('signatureInput').click()">
                ...
                <div class="card-body text-center">
                    <div class="mb-3 d-flex justify-content-center align-items-center">
                        @if($company->electronic_stamp)
                            <div>
                                <img src="{{ url($company->electronic_stamp_url) }}" alt="Cachet" class="img-fluid mb-2" style="max-height: 100px;">
                    ...
                    <form method="POST" action="{{ route('company.settings.stamp.update') }}" enctype="multipart/form-data" class="d-inline">
                        @csrf
                        <div class="mb-3">
                            <input type="file" class="form-control" name="stamp" accept="image/*" required style="display: none;" id="stampInput">
                            <button type="button" class="btn btn-outline-primary" onclick="document.getElementById('stampInput').click()">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (logoInput) {
        logoInput.addEventListener('change', function() {
            showFileName('logoFileName', this.files[0]);
        });
    }
    ...
    if (signatureInput) {
        signatureInput.addEventListener('change', function() {
            showFileName('signatureFileName', this.files[0]);
        });
    }
    ...
    if (stampInput) {
        stampInput.addEventListener('change', function() {
            showFileName('stampFileName', this.files[0]);
        });
    }
