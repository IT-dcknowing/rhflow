                    ...
                    <div class="card-body">
                        @if($workLocations->count() > 0)
                            <div class="table-responsive">
                                <table class="table table-hover border-top dataTable no-footer" id="work-locations-table">
                                    <thead>
                                        <tr>
                                            <th>Emplacement</th>
                                            <th>Type</th>
                                    ...
                                    <tbody>
                                        @foreach($workLocations as $location)
                                            {{-- data-location-id / data-location : lus par editWorkLocation() --}}
                                            <tr data-location-id="{{ $location->id }}" data-location='@json($location->toArray())'
                                                data-branch-name="{{ $location->branch->name ?? '' }}">
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar avatar-sm me-3">
                                                            <div
                                                                class="avatar-initial {{ $location->is_active ? 'bg-label-info' : 'bg-label-secondary' }} rounded">
                                                                <i
                                                                    class="fas fa-{{ $location->type == 'office' ? 'building' : ($location->type == 'remote' ? 'home' : 'map-marker-alt') }}"></i>
                                                            </div>
                                                        </div>
                                                        <h6 class="mb-0">{{ $location->name }}</h6>
                                                    </div>
                                                </td>
                                                <td><span class="badge bg-label-secondary">{{ ucfirst($location->type) }}</span>
                                                </td>
                                                <td>
                                                    @if($location->branch)
                                                        <small><i
                                                                class="fas fa-building me-1 text-muted"></i>{{ $location->branch->name }}</small>
                                                    @else
                                                ...
                                                <td>
                                                    @if($location->address)
                                                        <small class="text-muted"><i
                                                                class="fas fa-map-marker-alt me-1"></i>{{ $location->full_address }}</small>
                                                    @else
                                                        <small class="text-muted">-</small>
                                                    @endif
                                                </td>
                                                {{-- data-order : DataTables trie sur la valeur brute, pas sur le libelle --}}
                                                <td data-order="{{ $location->has_time_clock ? 1 : 0 }}">
                                                    @if($location->has_time_clock)
                                                        <span class="badge bg-label-success"><i
                                                                class="fas fa-clock me-1"></i>Configurée</span>
                                                    @else
                                                        <span class="badge bg-label-secondary">Aucune</span>
                                                    @endif
                                                </td>
                                                <td data-order="{{ $location->is_active ? 1 : 0 }}">
                                                    <span
                                                        class="badge {{ $location->is_active ? 'bg-label-success' : 'bg-label-secondary' }}">
                        ...
                        @else
                            <div class="text-center py-5">
                                ...
                                <button class="btn btn-primary" data-bs-toggle="modal"
                                    data-bs-target="#createWorkLocationModal">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" name="name" required
                                    placeholder="Ex: Bureau Principal, Site A...">
                            </div>
                            <div class="col-md-6 mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="description" rows="2"
                                placeholder="Description de l'emplacement..."></textarea>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-8 mb-3">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" id="address_autocomplete" name="address_display"
                                        placeholder="Tapez une adresse pour rechercher..." autocomplete="off" required>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="postal_code_display" placeholder="75001"
                                    readonly>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="state_display" placeholder="Île-de-France"
                                    readonly>
                            </div>
                            <div class="col-md-4 mb-3">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <div class="form-check">
                                    ...
                                    <input class="form-check-input" type="checkbox" name="has_time_clock" id="hasTimeClock"
                                        value="1">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-check">
                                    ...
                                    <input class="form-check-input" type="checkbox" name="allow_remote_clock"
                                        id="allowRemoteClock" value="1">
                        ...
                        <div id="timeClockSettings" style="display: none;">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" name="max_distance_meters" value="100" min="10"
                                    max="1000">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-8 mb-3">
                                <label class="form-label">Adresse (Localisation) <span class="text-danger">*</span></label>
                                <div class="input-group">
                                    <input type="text" class="form-control" id="edit_address_autocomplete"
                                        name="address_display" placeholder="Tapez une adresse pour rechercher..."
                                ...
                                <div id="edit_autocomplete_results" class="autocomplete-results" style="display: none;">
                                </div>
                                <small class="text-muted">Commencez à taper pour voir les suggestions d'adresses</small>
                            </div>
                            <div class="col-md-4 mb-3">
                                <label class="form-label">Code Postal</label>
                                <input type="text" class="form-control" id="edit_postal_code_display" placeholder="75001"
                                    readonly>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                <label class="form-label">Région</label>
                                <input type="text" class="form-control" id="edit_state_display" placeholder="Île-de-France"
                                    readonly>
                            </div>
                            <div class="col-md-4 mb-3">
                                <label class="form-label">Pays</label>
                                <input type="text" class="form-control" id="edit_country_display" placeholder="France"
                                    readonly>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <div class="form-check">
                                    ...
                                    <input class="form-check-input" type="checkbox" name="has_time_clock"
                                        id="editHasTimeClock" value="1">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-check">
                                    <input type="hidden" name="allow_remote_clock" value="0"
                                        id="editAllowRemoteClockHidden">
                                    <input class="form-check-input" type="checkbox" name="allow_remote_clock"
                                        id="editAllowRemoteClock" value="1">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                {{-- Champ cache : envoie 0 quand la case est decochee --}}
                        ...
                        <div id="editTimeClockSettings" style="display: none;">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Check-in Début</label>
                                    <input type="time" class="form-control" name="check_in_start" id="edit_check_in_start"
                                        value="08:00">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Check-in Fin</label>
                                    <input type="time" class="form-control" name="check_in_end" id="edit_check_in_end"
                                        value="09:30">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Check-out Début</label>
                                    <input type="time" class="form-control" name="check_out_start" id="edit_check_out_start"
                                        value="17:00">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Check-out Fin</label>
                                    <input type="time" class="form-control" name="check_out_end" id="edit_check_out_end"
                                        value="18:30">
                                </div>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Distance Max (mètres)</label>
                                <input type="number" class="form-control" name="max_distance_meters"
                                    id="edit_max_distance_meters" value="100" min="10" max="1000">
                                <small class="text-muted">Distance maximale autorisée pour le pointage géolocalisé</small>
                            </div>
                        </div>
                    </div>
...
@push('scripts')
    <script>
        ...
        $(function () {
            ...
            @if($workLocations->count() > 0)
                $('#work-locations-table').DataTable({
                    processing: true,
                    order: [[0, 'asc']],
                    columnDefs: [
        ...
        function editWorkLocation(id) {
            ...
            const branchId = locationData.branch_id || '';
            if (branchId && !editBranch.querySelector(`option[value="${branchId}"]`)) {
                // Succursale desactivee depuis : on l'ajoute pour ne pas la perdre a l'enregistrement
                const opt = document.createElement('option');
                opt.value = branchId;
                opt.textContent = (locationCard.dataset.branchName || 'Succursale') + ' (inactive)';
                editBranch.appendChild(opt);
            }
