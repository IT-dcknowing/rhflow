    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h4 class="mb-1">⚙️ Paramètres Entreprise</h4>
            ...
            <div class="card h-100">
                <div class="card-body text-center">
                    ...
                    <div class="progress mt-2" style="height: 4px;">
                        <div class="progress-bar bg-primary" style="width: {{ min(100, ($stats['total_branches'] ?? 0) * 20) }}%"></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card h-100">
                <div class="card-body text-center">
                    ...
                    <div class="progress mt-2" style="height: 4px;">
                        <div class="progress-bar bg-info" style="width: {{ min(100, ($stats['total_departments'] ?? 0) * 15) }}%"></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card h-100">
                <div class="card-body text-center">
                    ...
                    <div class="progress mt-2" style="height: 4px;">
                        <div class="progress-bar bg-warning" style="width: {{ min(100, ($stats['total_designations'] ?? 0) * 10) }}%"></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card h-100">
                <div class="card-body text-center">
                    ...
                    <div class="progress mt-2" style="height: 4px;">
                        <div class="progress-bar bg-success" style="width: {{ min(100, ($stats['total_leave_types'] ?? 0) * 25) }}%"></div>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6 mb-3">
                            <div class="d-flex align-items-center">
                                <div class="badge bg-label-primary me-2" style="width: 12px; height: 12px; border-radius: 50%;"></div>
                                <small><strong>{{ $stats['total_branches'] ?? 0 }}</strong> Sites</small>
                            </div>
                        </div>
                        <div class="col-sm-6 mb-3">
                            <div class="d-flex align-items-center">
                                <div class="badge bg-label-info me-2" style="width: 12px; height: 12px; border-radius: 50%;"></div>
                                <small><strong>{{ $stats['total_departments'] ?? 0 }}</strong> Services</small>
                            </div>
                        </div>
                        <div class="col-sm-6 mb-3">
                            <div class="d-flex align-items-center">
                                <div class="badge bg-label-warning me-2" style="width: 12px; height: 12px; border-radius: 50%;"></div>
                                <small><strong>{{ $stats['total_designations'] ?? 0 }}</strong> Postes</small>
                            </div>
                        </div>
                        <div class="col-sm-6 mb-3">
                            <div class="d-flex align-items-center">
                                <div class="badge bg-label-success me-2" style="width: 12px; height: 12px; border-radius: 50%;"></div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <span class="badge bg-label-primary">Configuration</span>
                </div>
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-md-6 mb-3">
                            <div class="d-grid">
                                <a href="{{ route('company.settings.leave-types.index') }}" class="btn btn-outline-success">
                                    <div class="d-flex align-items-center justify-content-center">
                        ...
                        <div class="col-xl-3 col-md-6 mb-3">
                            <div class="d-grid">
                                <a href="{{ route('company.settings.loan-types.index') }}" class="btn btn-outline-danger">
                                    <div class="d-flex align-items-center justify-content-center">
                        ...
                        <div class="col-xl-3 col-md-6 mb-3">
                            <div class="d-grid">
                                <a href="{{ route('company.settings.work-locations.index') }}" class="btn btn-outline-info">
                                    <div class="d-flex align-items-center justify-content-center">
                        ...
                        <div class="col-xl-3 col-md-6 mb-3">
                            <div class="d-grid">
                                <a href="{{ route('company.settings.branches.index') }}" class="btn btn-outline-primary">
                                    <div class="d-flex align-items-center justify-content-center">
                        ...
                        <div class="col-xl-3 col-md-6 mb-3">
                            <div class="d-grid">
                                <a href="{{ route('company.settings.departments.index') }}" class="btn btn-outline-info">
                                    <div class="d-flex align-items-center justify-content-center">
                        ...
                        <div class="col-xl-3 col-md-6 mb-3">
                            <div class="d-grid">
                                <a href="{{ route('company.settings.designations.index') }}" class="btn btn-outline-warning">
                                    <div class="d-flex align-items-center justify-content-center">
            ...
            <form method="POST" action="{{ route('company.settings.logo.update') }}" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="text-center">
                        @if($company->logo)
                            <img src="{{ $company->logo_url }}" alt="Logo actuel" class="img-fluid mb-3" style="max-height: 100px;">
                        @endif
                    </div>
                </div>
        ...
        <div class="modal-content">
            ...
            <form method="POST" action="{{ route('company.settings.signature.update') }}" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="text-center">
                        @if($company->electronic_signature)
                            <img src="{{ $company->electronic_signature_url }}" alt="Signature actuelle" class="img-fluid mb-3" style="max-height: 100px;">
                        @endif
                    </div>
                </div>
                <div class="modal-footer">
        ...
        <div class="modal-content">
            ...
            <form method="POST" action="{{ route('company.settings.stamp.update') }}" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="text-center">
                        @if($company->electronic_stamp)
                            <img src="{{ $company->electronic_stamp_url }}" alt="Cachet actuel" class="img-fluid mb-3" style="max-height: 100px;">
                        @endif
                    </div>
                </div>
                <div class="modal-footer">
