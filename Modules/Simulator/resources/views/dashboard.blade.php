                ...
                <div class="card-body">
                    <div class="row">
                                ...
                                <option value="099">{{ __('Autre employé') }}</option>
                                    @if (!empty($employees))
                                        @foreach ($employees as $emp)
                                            <option value="{{$emp->id}}"
                                            data-salaire="{{ $emp->get_net_salary() }}"
                                            data-situation="{{$emp->martalstatu_id}}" data-enfant="{{$emp->enfant}}" data-personneinf="{{$emp->personneinf}}"
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="number" name="net_pay" class="form-control" id="net_pay" required="required" placeholder="Net à Atteindre" />
                            @error('net_pay')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="mb-3 col-md-4">
                            ...
                            <select type="text" name="situation_mat" class="form-select" id="situation_mat" onchange="status()">
                                @if (!empty($situations))
                        ...
                        <div class="mb-3 col-md-4">
                            ...
                            <select type="text" name="emp_personnes" class="form-select" id="emp_personnes" onchange="status()">
                                @for ($i = 0; $i <= 5; $i++)
                                    <option value="{{ $i }}">{{ $i }}</option>
                                @endfor
                            </select>
                        ...
                        <div class="mb-3 col-md-4">
                            ...
                            <input type="text" name="part_igr" class="form-control" id="part_igr" placeholder="Nombre de parts" readonly />
                        </div>
                        <div class="mb-3 col-md-4">
                        ...
                        <div class="mb-3 col-md-4">
                            ...
                            <input type="number" id="tp_brut" class="form-control" name="tp_brut" required="" min="0" value="0" placeholder="Entrez la prime de transport">
                            <input type="number" id="tp_brut_libre" class="form-control d-none" name="tp_brut_libre" required="" min="0" placeholder="Entrez la prime de transport">
                        </div>

                        <div class="mb-3 col-md-4">
                            <label for="exo_fisc_100" class="form-label">Autres primes exonérées fiscales (100%)</label>
                            <input type="number" name="exo_fisc_100" class="form-control" id="exo_fisc_100" required="required" value="0" />
                            @error('exo_fisc_100')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="mb-3 col-md-4">
                            ...
                            <input type="number" name="exo_fisc_10" class="form-control" id="exo_fisc_10" required="required" value="0" />
                            @error('exo_fisc_10')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="mb-3 col-md-4">
                            ...
                            <input type="number" name="exo_soci" class="form-control" id="exo_soci" required="required" value="0" />
                            @error('exo_soci')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
        ...
        <div id="result_paie" style="display:none;">
            <div class="card">
                            ...
                            <table class="table table-bordered">
                                <thead>
                                    <tr class="" style="background-color: #000;">
                                        <th colspan="4" class="text-center"><h5 class="text-white mb-0">{{ __('RESUME - SIMULATION DE PAIE') }}</h5></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td width="35%"><strong>Matricule :</strong></td>
                                        <td width="15%" class="text-end" style="background-color: #000;"><strong><span id="numemp" class="text-warning"></span></strong></td>
                                        <td width="35%"><strong>CNPS</strong></td>
                                        <td width="15%" class="text-end" style="background-color: #000;"><strong><span id="resultatcnps" class="text-warning"></span> <span class="text-white">FCFA</span></strong></td>
                                    </tr>
                                    <tr>
                                        <td><strong>Nombre de parts : </strong></td>
                                        <td class="text-end" style="background-color: #000;"><strong><span id="resultatpart" class="text-warning"></span></strong></td>
                                        <td><strong>Bénéficiaires CMU : </strong></td>
                                        <td class="text-end" style="background-color: #000;"><strong><span id="resultatcmu" class="text-warning"></span> <span class="text-white">FCFA</span></strong></td>
                                    </tr>
                                    <tr>
                                        <td><strong>Prime de transport :</strong></td>
                                        <td class="text-end" style="background-color: #000;"><strong><span id="resultattp" class="text-warning"></span> <span class="text-white">FCFA</span></strong></td>
                                        <td><strong>Total Retenues sociales :</strong></td>
                                        <td class="text-end" style="background-color: #000;"><strong><span id="totalsocial" class="text-warning"></span> <span class="text-white">FCFA</span></strong></td>
                                    </tr>
                                    <tr>
                                        <td><strong>Net à atteindre : </strong></td>
                                        <td class="text-end" style="background-color: #000;"><strong><span id="resultatnet" class="text-warning"></span> <span class="text-white">FCFA</span></strong></td>
                                        <td><strong>Autres primes exonérées fiscales :</strong></td>
                                        <td class="text-end" style="background-color: #000;"><strong><span id="autresprimes" class="text-warning"></span> <span class="text-white">FCFA</span></strong></td>
                                    </tr>
                                    <tr>
                                        <td><strong>Salaire Brut fiscal :</strong></td>
                                        <td class="text-end" style="background-color: #000;"><strong><span id="totalsbi" class="text-warning"></span> <span class="text-white">FCFA</span></strong></td>
                                        <td><strong>Salaire brut social :</strong></td>
                                        <td class="text-end" style="background-color: #000;"><strong><span id="totalsbs" class="text-warning"></span> <span class="text-white">FCFA</span></strong></td>
                                    </tr>
                                    <tr>
                                        <td><strong>Impôt Brut : </strong></td>
                                        <td class="text-end" style="background-color: #000;"><strong><span id="resultatimp" class="text-warning"></span> <span class="text-white">FCFA</span></strong></td>
                                        <td><strong>RICF : </strong></td>
                                        <td class="text-end" style="background-color: #000;"><strong><span id="resultatricft" class="text-warning"></span> <span class="text-white">FCFA</span></strong></td>
                                    </tr>
                                    <tr>
                                        <td><strong>Impôt Net :</strong></td>
                                        <td class="text-end" style="background-color: #000;"><strong><span id="resultatnetimp" class="text-warning"></span> <span class="text-white">FCFA</span></strong></td>
                                        <td><strong>Total retenues imposables: </strong></td>
                                        <td class="text-end" style="background-color: #000;"><strong><span id="totalretenues" class="text-warning"></span> <span class="text-white">FCFA</span></strong></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-end" style="background-color: #000;"><strong><span id="resultatbrut" class="text-danger"></span> <span class="text-white">FCFA</span></strong></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                ...
                <div class="card-footer">
                    <div>
                        <img src="{{ asset('img/illustrations/pencil-rocket.png') }}" alt="Pencil Rocket" class="img-fluid" style="width: 100px; height: auto; position: relative; bottom: 0;" align="right">
                    </div>
