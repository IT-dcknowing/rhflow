                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <select class="select2 form-select @error('employee_id') is-invalid @enderror" id="employee_id" name="employee_id" required>
                            ...
                            <div class="col-md-12">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control @error('contract_description') is-invalid @enderror" id="contract_description" name="contract_description" rows="5">{{ old('contract_description') }}</textarea>
