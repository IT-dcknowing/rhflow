                                ...
                                @forelse($contractTypes as $type)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <span
                                                class="badge bg-info">{{ $type->contracts->where('company_id', Auth::user()->company_id)->count() }}</span>
                                        </td>
                                        <td>
                                            <div class="d-flex">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <small class="text-muted">Total:
                                    {{ $contractTypes->total() ?? count($contractTypes) }}</small>
                            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div id="delete-warning" class="alert alert-warning d-none">
                        ...
                        Ce type est utilisé par <strong id="delete-contract-count"></strong> contrat(s). La suppression
                        pourrait affecter ces contrats.
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal">Annuler</button>
