    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h4 class="mb-1">📄 Détails du contrat</h4>
                    <nav aria-label="breadcrumb"> 
                        <ol class="breadcrumb mb-0">
                            <li class="breadcrumb-item">
                                <a href="{{ route('company.contracts.index') }}">Contrats</a>
                            </li>
                            <li class="breadcrumb-item active">{{ $contract->subject }}</li>
                        </ol>
                    </nav>
                </div>
                <div>
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li>
                                <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#addAvenantModal">
                            ...
                            <li>
                                <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#deleteContractModal">
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h5 class="mb-0">{{ $contract->subject }}</h5>
                            <p class="text-muted mb-0">Référence: #{{ $contract->id }}</p>
                        </div>
                        <div>
                            @php
                                $statusClass = [
        ...
        <div class="col-md-8 mb-4">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <p>{{ $contract->start_date ? date('d/m/Y', strtotime($contract->start_date)) : 'Non définie' }}</p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label class="form-label fw-bold">Date de fin</label>
                                <p>{{ $contract->end_date ? date('d/m/Y', strtotime($contract->end_date)) : 'Non définie' }}</p>
                            </div>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <p>{{ $contract->duration ?? 'Non définie' }} {{ $contract->duration > 1 ? 'mois' : 'mois' }}</p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label class="form-label fw-bold">Valeur</label>
                                <p>{{ $contract->value ? number_format($contract->value, 0, ',', ' ') . ' XOF' : 'Non définie' }}</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#addAvenantModal">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($avenant->file_path)
                                            <a href="{{ route('company.contracts.avenant.download', $avenant->id) }}" class="btn btn-sm btn-outline-primary">
                                    ...
                                    <td>
                                        <div class="d-flex gap-2">
                                            ...
                                            <form action="{{ route('company.contracts.avenant.destroy', $avenant->id) }}" method="POST" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer cet avenant ?')">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="btn btn-sm btn-icon btn-danger" data-bs-toggle="tooltip" title="Supprimer">
        ...
        <div class="col-md-4">
            ...
            <div class="card mb-4">
                ...
                <div class="card-footer">
                    <form action="{{ route('company.contracts.attachment.add', $contract->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                        ...
                        <div class="col-12">
                            ...
                            @if($contract->employee_signature)
                                <div class="border rounded p-3 text-center">
                                    <img src="{{ asset('storage/' . $contract->employee_signature) }}" alt="Signature employé" class="img-fluid" style="max-height: 100px;">
                                    <p class="text-muted mb-0 mt-2">Signé le {{ date('d/m/Y', strtotime($contract->employee_signature_date)) }}</p>
                                </div>
                            @else
                                <div class="border rounded p-3 text-center">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <label class="form-label fw-bold">Signature de l'entreprise</label>
                            @if($contract->company_signature)
                                <div class="border rounded p-3 text-center">
                                    <img src="{{ asset('storage/' . $contract->company_signature) }}" alt="Signature entreprise" class="img-fluid" style="max-height: 100px;">
                                    <p class="text-muted mb-0 mt-2">Signé le {{ date('d/m/Y', strtotime($contract->company_signature_date)) }}</p>
                                </div>
                            @else
                                <div class="border rounded p-3 text-center">
                                    <p class="text-muted mb-0">Non signé</p>
                ...
                @if(!$contract->employee_signature || !$contract->company_signature)
                <div class="card-footer">
...
<div class="modal fade" id="addAvenantModal" tabindex="-1" aria-labelledby="addAvenantModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="{{ route('company.contracts.avenant.add', $contract->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    ...
                    <div id="amountField" class="mb-3" style="display: none">
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label for="branch_id" class="form-label">Succursale<span class="text-danger pl-1"> *</span></label>
                            ...
                            <div class="form-group col-md-6">
                                <div class="form-icon-user" id="department_id">
                                    <label for="department_id" class="form-label">Department<span class="text-danger pl-1"> *</span></label>
                                    <select class="form-select department_id" name="department_id" id="department_id" required>
                            ...
                            <div class="form-group col-md-6">
                                <label for="designation_id" class="form-label">Post<span class="text-danger pl-1"> *</span></label>
                            ...
                            <div class="form-group col-md-6">
                                <label for="contract_types_id" class="form-label">Type de contrat<span class="text-danger pl-1"> *</span></label>
                                <select type="text" name="contract_types_id" class="form-select" id="contract_types_id" onchange="contractend()"> 
                                    <option value="">-- Sélectionner un contrat --</option>
                                    @if (!empty($contractTypes))
                                        @foreach ($contractTypes as $type)  
                                            <option value="{{ $type->id }}" @if($contract->employee->contrat == $type->id) selected="selected" @endif>
                                                {{ $type->name }}
                                            </option>
                                        @endforeach
                                    @endif
                            ...
                            <div class="form-group col-md-6">
                                <label for="contrat_start" class="form-label">Date de debut du contrat<span class="text-danger pl-1"> *</span></label>
                                <input type="date" name="contrat_start" class="form-control current_date" id="contrat_start" autocomplete="off" placeholder="Date de debut du contrat" value="{{ $contract->start_date }}">
                            </div>
                            <div id="end" class="form-group col-md-6">
                                <label for="contrat_end" class="form-label">Date de fin du contrat</label>
                                <input type="date" name="contrat_end" class="form-control current_date" id="contrat_end" autocomplete="off" placeholder="Date de fin du contrat" value="{{ $contract->end_date }}">
                            </div>
                             <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('duration') is-invalid @enderror" id="duration" name="duration" value="{{ old('duration') }}" placeholder="Ex: 12 mois">
                                    @error('duration')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                    ...
                    <div id="sal_cate" style="display: none;">
                        <label for="avenant_amount" class="form-label">Ancien salaire catégoriel : <strong style="color: red">{{ number_format($contract->employee->salary, 0 , '.' , ' ') }} FCFA</strong> | Ancien salaire net : <strong style="color: red">{{ number_format($contract->employee->get_net_salary(), 0 , '.' , ' ') }} FCFA</strong></label>
                        <hr>
                        <div class="row">
                            @php
                                $jobCategories = '';
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select type="text" name="category_job_id" class="form-select" id="category_job_id">
                                    ...
                                    @foreach($jobCategories as $jobCategorie)
                                        <option value="{{ $jobCategorie->id }}" {{ $jobCategorie->id == $contract->employee->categorie ? 'selected' : '' }}>{{ $jobCategorie->title }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="category_id" class="form-label">Sélectionner la catégorie<span class="text-danger pl-1"> *</span></label>
                                <select type="text" name="category_id" class="form-select" id="category_id">
                                    <option value="{{ !empty($contract->employee->sous_categorie) ? $contract->employee->sous_categorie : '' }}" data-salaireminie="{{ $contract->employee->salary_horaire }}" data-salairemensuel="{{ $contract->employee->salary }}">Catégorie : {{$contract->employee->sous_categorie}}  / S. Horaire : {{$contract->employee->salary_horaire}} / S. Mensuel : {{$contract->employee->salary}}</option>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="number" name="salaire_minima_horaire" class="form-control" id="salaire_minima_horaire" readonly value="{{ $contract->employee->salary_horaire }}">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="salaire_minima_mensuel" class="form-label">Salaire Catégoriel mensuel</label>
                                <input type="number" name="salaire_minima_mensuel" class="form-control" id="salaire_minima_mensuel" readonly value="{{ $contract->employee->salary }}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="avenant_description" id="avenant_description" rows="3"></textarea>
                    </div>
                    <div class="input-group">
                        <input type="file" class="form-control" name="attachment" id="attachment">
                        <button class="btn btn-primary" type="submit">Ajouter</button>
...
<div class="modal fade" id="deleteAttachmentModal" tabindex="-1" aria-labelledby="deleteAttachmentModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Êtes-vous sûr de vouloir supprimer cette pièce jointe : <strong id="delete-attachment-name"></strong> ?</p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal">Annuler</button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="alert alert-warning">
                    ...
                    Cette action est irréversible. Toutes les pièces jointes et avenants associés seront également supprimés.
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal">Annuler</button>
