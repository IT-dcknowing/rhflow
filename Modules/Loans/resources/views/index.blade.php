                    ...
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item active">Prêts @if($periode) - Période : {{ $periode->nom }} |
                                    Statut : <span
                    ...
                    <div>
                        @if($periode)
                            ...
                            <a type="button" class="btn btn-primary"
                                href="{{ route('company.loans.create') }}@if($periode)?periode_id={{ $periode->id }}@endif">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            @if($loan->is_active)
                                                <form action="{{ route('company.loans.deactivate', $loan->id) }}" method="POST"
                                                    class="d-inline me-2"
                                            ...
                                            @else
                                                <form action="{{ route('company.loans.activate', $loan->id) }}" method="POST"
                                                    class="d-inline me-2"
