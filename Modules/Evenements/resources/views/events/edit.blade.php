    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="{{ route('company.evenements.events.show', $event) }}" class="btn btn-outline-secondary">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('company.evenements.events.update', $event) }}" method="POST" id="eventForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control datetimepicker @error('start_date') is-invalid @enderror" 
                                                   ...
                                                   value="{{ old('start_date', $event->start_date->format('Y-m-d H:i')) }}" required>
                                            @error('start_date')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control datetimepicker @error('end_date') is-invalid @enderror" 
                                                   ...
                                                   value="{{ old('end_date', $event->end_date ? $event->end_date->format('Y-m-d H:i') : '') }}">
                                            @error('end_date')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select" id="recurrence_rule" name="recurrence_rule">
                                                        ...
                                                        <option value="daily" {{ old('recurrence_rule', $event->recurrence_rule) == 'daily' ? 'selected' : '' }}>Tous les jours</option>
                                                        <option value="weekly" {{ old('recurrence_rule', $event->recurrence_rule) == 'weekly' ? 'selected' : '' }}>Toutes les semaines</option>
                                                        <option value="monthly" {{ old('recurrence_rule', $event->recurrence_rule) == 'monthly' ? 'selected' : '' }}>Tous les mois</option>
                                                        <option value="yearly" {{ old('recurrence_rule', $event->recurrence_rule) == 'yearly' ? 'selected' : '' }}>Tous les ans</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="mb-3" id="recurrence_until_container" style="display: none;">
                                                    ...
                                                    <input type="text" class="form-control datepicker" 
                                                           ...
                                                           value="{{ old('recurrence_until', $event->recurrence_until ? $event->recurrence_until->format('Y-m-d') : '') }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body" id="reminder_options" style="{{ old('send_reminder', $event->send_reminder) ? '' : 'display: none;' }}">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" class="form-control" id="reminder_minutes_before" 
                                                           ...
                                                           value="{{ old('reminder_minutes_before', $event->reminder_minutes_before ?? 30) }}">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="tab-content" id="participantsTabContent">
                                            ...
                                            <div class="tab-pane fade show active" id="employees" role="tabpanel">
                                                        ...
                                                        <optgroup label="{{ $department }}">
                                                            @foreach($deptEmployees as $employee)
                                                                <option value="{{ $employee->id }}" 
                                                                    {{ in_array($employee->id, $selectedParticipants['employees'] ?? []) ? 'selected' : '' }}>
                                                                    {{ $employee->full_name }}
                                                                </option>
                                                            @endforeach
                                                        </optgroup>
                                                ...
                                                <input type="hidden" name="employee_participants" id="employee_participants_input" value="{{ json_encode($selectedParticipants['employees'] ?? []) }}">
                                            </div>
                                                ...
                                                <select class="form-select select2" id="department_participants" multiple>
                                                    @foreach($departments as $department)
                                                        <option value="{{ $department->id }}" 
                                                            {{ in_array($department->id, $selectedParticipants['departments'] ?? []) ? 'selected' : '' }}>
                                                            {{ $department->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                                <input type="hidden" name="department_participants" id="department_participants_input" value="{{ json_encode($selectedParticipants['departments'] ?? []) }}">
                                            </div>
                                            ...
                                            <div class="tab-pane fade" id="external" role="tabpanel">
                                                <div id="external_participants_container">
                                                    ...
                                                    <div id="external_participants_list">
                                                        @foreach($selectedParticipants['external'] ?? [] as $external)
                                                            <div class="d-flex justify-content-between align-items-center mb-2 p-2 border rounded" data-id="{{ $external['id'] }}">
                                                                <div>
                                                                    <strong>{{ $external['name'] }}</strong><br>
                                                                    <small class="text-muted">{{ $external['email'] }}</small>
                                                                </div>
                                                    ...
                                                    <input type="hidden" name="external_participants" id="external_participants_input" 
                                                           value="{{ json_encode($selectedParticipants['external'] ?? []) }}">
                                                </div>
                                            </div>
                                        </div>
                                        
                                        <div class="form-check mt-3">
                                            <input class="form-check-input" type="checkbox" id="send_invitations" name="send_invitations" value="1">
                                            <label class="form-check-label" for="send_invitations">
                                                Envoyer des notifications de mise à jour aux participants
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-text p-0 border-0">
                                                    <input type="color" class="form-control form-control-color" 
                                                           id="color" name="color" value="{{ old('color', $event->color ?? '#3b82f6') }}" 
                                                           title="Choisir une couleur">
                                                </span>
                                                <input type="text" class="form-control" id="color_hex" 
                                                       value="{{ old('color', $event->color ?? '#3b82f6') }}" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="mb-2">
                                            <button type="button" class="btn btn-outline-primary w-100 mb-2" id="sync_google"
                                                    ...
                                                    title="{{ $event->google_calendar_event_id ? 'Mettre à jour dans Google Calendar' : 'Ajouter à Google Calendar' }}">
                                                <i class="fab fa-google me-2"></i> 
                                                {{ $event->google_calendar_event_id ? 'Mettre à jour Google' : 'Google Calendar' }}
                                                @if($event->google_calendar_event_id)
                                                    <span class="badge bg-success ms-2">Synchronisé</span>
                                                @endif
                                            </button>
                                            
                                            <button type="button" class="btn btn-outline-primary w-100" id="sync_outlook"
                                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                                    title="{{ $event->outlook_event_id ? 'Mettre à jour dans Outlook' : 'Ajouter à Outlook' }}">
                                                <i class="fab fa-microsoft me-2"></i> 
                                                {{ $event->outlook_event_id ? 'Mettre à jour Outlook' : 'Outlook Calendar' }}
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            ...
                            <div>
                                <a href="{{ route('company.evenements.events.show', $event) }}" class="btn btn-outline-secondary me-2">
                                    Annuler
                                </a>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        $('input[name="delete_series"]').on('change', function() {
            $('input[name="delete_series"]').val($(this).val());
        });
