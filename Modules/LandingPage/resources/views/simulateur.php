<!DOCTYPE html>
<html lang="fr" dir="{{ $setting['SITE_RTL'] == 'on' ? 'rtl' : '' }}">
...
<head>
    ...
    <style>
        ...
        .brut-result-table th,
        .brut-result-table td {
        ...
        #tableau.hide-old-regime tr > :nth-child(4),
        #tableau.hide-old-regime tr > :nth-child(5),
        #tableau.hide-old-regime tr > :nth-child(6),
        #tableau.hide-old-regime tr > :nth-child(7) {
            display: none;
        }
    </style>
    @stack('styles')
...
<header class="main-header bg-primary">
    <div class="background">
        <strong class="mb-0 text clignoter">SIMULATEUR DE LIVRE DE PAIE RHFLOW</strong>
    </div>
    <div class="container" style="height: 70px;" >
        <nav class="navbar navbar-expand-md  default top-nav-collapse" style="margin-top:-10px;">
            <div class="header-left" style="margin-top:-22px;">
                <a class="navbar-brand bg-transparent" href="#">
                    <img src="{{ $logo . '/' . $settings['site_logo'] . '?' . time() }}" alt="logo">
                </a>
            </div>
            <div class="collapse navbar-collapse justify-content-center" style="margin-top:-22px; margin-left:200px;">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a  class="btn-submit btn btn-primary" href="https://dc-knowing.com/GRH/" id="lienAfficherDiv1" style="background-color: black;">DCK APP GRH</a>
                    </li>
                    <!--<li class="nav-item">
                        <a class="nav-link" href="#" id="lienAfficherDiv2" onclick="afficherDiv('NetBrut', 'BrutNet')">Net au Brut</a>
                    </li>-->
                </ul>
            </div>
            <div class="collapse navbar-collapse justify-content-end" style="margin-top:-22px;" id="navbarTogglerDemo01">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link active" href="https://dc-knowing.com/GRH/simulateur">Accueil</a>
                    </li>
            ...
            <!--<div class="ms-auto d-flex justify-content-end gap-2">
                <a href="{{ route('login') }}" class="btn btn-outline-dark rounded"><span
                        class="hide-mob me-2">Connexion </span> <i data-feather="log-in"></i></a>
                <a href="{{ route('register') }}" class="btn btn-outline-dark rounded"><span
                        class="hide-mob me-2">Inscription</span> <i data-feather="user-check"></i></a>-->
...
<!-- [ Banner ] start -->
    <section class="main-banner " id="home" style="height: auto;">
        <div id="BrutNet" style="display: block;">
            <div class="container">
                <div class="row align-items-center" align="center" style="margin-top: -35px;">
                    ...
                    <h6>Outil d’aide à l’application de la réforme fiscale relative à l’impôt sur les traitements et salaires (ITS)</h6>
                </div>
                <br>
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <div id="monParagraphe" style="display:none; padding: 0.5em;" class="card shadow-none">
                            <p>Le simulateur du livre de paie vient répondre au besoin <b>d’évaluation de l’impact de la nouvelle disposition
                                des Impôts sur Traitements et Salaires (ITS) </b>sur l’ensemble des salariés de votre entreprise.
                                Il se positionne comme un <b>outil d’aide à l’application du nouveau dispositif des ITS</b> par une
                                appréciation du coût salarial supporté par l’entreprise. Lequel coût ne devrait en principe pas augmenter. Car la réforme vise pour la plupart des salariés, la baisse des retenues
                                fiscales sur salaire pour une augmentation du salaire net. Selon le gouvernement ivoirien, cette nouvelle approche des
                                ITS a pour objectif principal l’augmentation du pouvoir d’achat des salariés du secteur privé. En pratique,
                                le coût salarial pourrait augmenter dans les cas suivants :</p>

                            <ul>
                                <li>L’application de la prime d’ancienneté</li>
                                <li>La tranche des salaires qui subissent une perte en raison de la réforme. Il est recommandé aux employeurs, un effort d’ajustement pour cette catégorie de salariés.</li>
                            </ul>
                        </div>
                        <h5 style="cursor: pointer;">
                        ...
                        <div id="monParagraphe2" style="display:none; padding: 0.5em;" class="card shadow-none">
                            <p>Il est recommandé de se munir du plus récent livre de paie (excepté celui de décembre) qui contient les informations sur les salariés telles que :</p>

                            <ul>
                                <li><b>Type d’employé :</b> local ou expatrié</li>
                                <li><b>La situation de famille :</b> situation matrimoniale, nombre d’enfants et nombre de bénéficiaires à la CMU</li>
                                <li><b>Le Salaire brut total (y compris toutes les primes) :</b> ce total cumule tout le salaire brut tel que le salaire de base, le sursalaire, la prime d’ancienneté, la prime de transport, la prime de responsabilité, les autres rémunérations et primes</li>
                                <li><b>Le salaire brut imposable : </b>la partie du salaire brut soumis à impôt (sans l’abattement de 20%)</li>
                                <li><b>Le salaire brut social </b>soumis à la cotisation CNPS</li>
                            </ul>

                            <p> Puis à l’aide du bouton « Ajouter », insérer les employés. Dans un souci de confidentialité,
                                il ne vous sera demandé ni les informations sur votre société ni l’identité de vos salariés,
                                qui seront nommés par une numérotation automatisée de l’employé 1 à l’employé n selon le nombre de salariés de votre entreprise.
                                Une fois terminé,
                            ...
                            <section>
                                ...
                                <p>
                                    Avant de commencer, assurez-vous de suivre ces étapes simples pour télécharger le modèle Excel nécessaire :
                                </p>
                                <ol>
                                    <li>Cliquez sur le bouton ci-dessous pour télécharger le modèle Excel.</li>
                                    <li>Le fichier téléchargé contient la structure appropriée pour l'importation des données.</li>
                                    <li>Enregistrez le fichier sur votre ordinateur dans un emplacement facilement accessible.</li>
                                </ol>

                                <p>
                                    Assurez-vous de ne pas modifier la structure du fichier pour garantir une importation réussie.
                                </p>
                            </section>
                            ...
                            <section>
                                ...
                                <p>
                                    Maintenant que vous avez téléchargé le modèle Excel, suivez ces étapes pour importer vos données :
                                </p>
                                <ol>
                                    <li>Rassemblez toutes les informations nécessaires que vous souhaitez importer.</li>
                                    <li>Remplissez le modèle Excel téléchargé avec vos données.</li>
                                    <li>Assurez-vous que toutes les cellules obligatoires sont remplies correctement.</li>
                                ...
                                <p>
                                    Si vous rencontrez des difficultés ou si vous avez des questions, n'hésitez pas à nous contacter <a href="https://dc-knowing.com/GRH/pages/%C3%80-propos_de#contact">ici</a>  pour obtenir de l'aide.
                                </p>
                            </section>
                        </div>
                        <h5 style="cursor: pointer;">
                        ...
                        <div id="monParagraphe3" style="display:none; padding: 0.5em;" class="card shadow-none">
                            ...
                            <ul>
                                <li><b>Le traitement des ITS selon l’ancienne formule par salarié </b>à comparer avec les informations de votre livre de paie qui a servi au renseignement du simulateur</li>
                                <li><b>Le nouveau traitement des ITS par salarié </b>avec les composantes des nouvelles retenues fiscales</li>
                                <li><b>La différence de traitement des ITS par salarié</b> qui ressort un gain ou une perte pour le salarié en raison de l’application de la réforme</li>
                                <li><b>Les anciens salaires nets</b> à vérifier sur le livre de paie détenu</li>
                                <li><b>Les nouveaux salaires nets à payer </b>à compter du mois de janvier (veillez à l’application de la prime d’ancienneté)</li>
                                <li><b>La différence des salaires nets</b> qui devrait être identique à la différence des retenues fiscales</li>
                                <li><b>Le rangement des salariés</b> par catégorie de <b>gain</b> ou de <b>perte</b> sur salaire</li>
                        ...
                        <div id="monParagraphe4" style="display:none; padding: 0.5em;" class="card shadow-none">
                            ...
                            <ul>
                                <li>Payer effectivement les nouveaux salaires nets qui présentent un gain. Ils pourraient connaître une augmentation supplémentaire en raison de la prime d’ancienneté.</li>
                                <li>Entreprendre une politique d’ajustement des salaires qui subissent une perte en raison de la réforme. Cet ajustement pourrait consister à garantir au moins l’ancien net.</li>
                            </ul>
                        </div>
                        <br>
                    </div>
            ...
            <div class="container card" style="padding: 10px;">
                <h2 align="center">Exclusif : Découvrez notre tout nouveau calculateur de salaire net au brut ! <br/>Essayer-le dès maintenant et simplifiez vos calculs de rémunération.<br/><br/>
                    <button class="btn-submit btn btn-primary" id="boutonChanger" onclick="afficherDiv()">Net au Brut</button></h2>
            </div>
            <div id="brutaunet" class="container" style="display: block;">
                <div class="row gy-3 ">
                    <div class="col-xxl-12 align-items-center ">
                        <div class="row">
                            ...
                            <div class="card">
                                ...
                                <div class="col-xl-12"><p>Cher utilisateur,</p>
                                    <p>Nous sommes ravis de vous offrir la flexibilité de choisir la méthode qui vous convient le mieux pour effectuer des simulations. Vous avez deux options pratiques :</p>
                                </div>
                                <div class="row">
                                    <div class=" col-xl-6">
                                        <ul>
                                            <li><strong>1- Simulation Employé par Employé :</strong> Pour une approche plus détaillée ou pour des ajustements spécifiques, choisissez de simuler employé par employé. Cela vous permettra de personnaliser chaque simulation selon les besoins individuels.</li>
                                        </ul>
                                    ...
                                    <div class="col-xl-6">
                                        <ul>
                                            <li><strong>2- Simulation par Importation :</strong> Si vous préférez gagner du temps et traiter plusieurs employés en une seule fois, utilisez la fonction d'importation. Téléchargez simplement le fichier de simulation, suivez les instructions, et vous serez prêt(e) en un rien de temps.</li>
                                        </ul>
                                        <button class="btn btn-info" id="simulerimport" onclick="affichedivimport()">Simuler par importation (Fichier Excel)</button>
                                    </div>
                                    <!--<div class="col-xl-2">
                                        <iframe src="https://giphy.com/embed/D6HsZC03dz8zYgevTI" width="300" height="300" frameBorder="0" class="giphy-embed" allowFullScreen></iframe>
                                    </div>-->
                                </div>
                                <br/><br/>
                            </div>
                        </div>
                        <div id="form_input" class="card bg-dark shadow-none" style="display: block;">
                            <div class="card-header">
                                <div class="row align-items-center" align="center">
                                    <marquee behavior="" direction="">
                                        <h4 style="color: #fff;">Le simulateur est régulièrement mis à jour par nos équipes grâce à vos contributions et observations.</h4>
                                    </marquee>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4" align="center">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <strong><label style="color: white;">Taux d'accident de travail (CNPS) :</label></strong>
                            ...
                            <div class="card-body">
                                <div id="form" class="rowdiv">

                                </div>
                                <div class="col-md-12 text-start">
                                    <button class="btn-submit btn btn-primary" id="ajout" onclick="Ajout()" disabled>{{ __('Ajouter') }}</button>
                                    <button class="btn-submit btn btn-primary" id="ajout2" onclick="Ajout2()" hidden>{{ __('Ajouter') }}</button>
                                    <button class="btn-submit btn btn-danger" id="retrait" onclick="Retrait()" disabled hidden>{{ __('Supprimer') }}</button>
                                </div>
                            </div>
                            <div class="card-footer text-end">
                                <button class="btn-submit btn btn-warning" id="update" onclick="updatetab()" disabled>
                                    {{ __('Modifier') }}
                                </button>
                                <button class="btn-submit btn btn-primary" id="addSig" onclick="Resultat()" disabled>
                                    {{ __('Simuler') }}
                                </button>
                        ...
                        <div id="etape" class="card bg-dark shadow-none" style="display: none;">
                                ...
                                <div class="col-md-6" style=" padding:10px;">
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            ...
                                            <button id="dawonload" class="btn btn-success" onclick="telechargerModele()" disabled>Télécharger le modèle Excel</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6" style=" padding:10px;">
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            ...
                                            <button class="btn btn-success" id="importetape" onclick="importerFichierXLSX()" disabled>Importer votre fichier</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row ">
                            <div>
                                <div class="card">
                                    <div class="card-header">
                                        <div class="row">
                                            <div class="col-md-6"><h5>{{ __('Resultat de Paie') }}</h5></div>
                                            <div class="col-md-6" align="right">
                                                <button class="btn btn-success" id="exporterExcel" onclick="exportToExcel()" disabled>Exporter en Excel</button>
                                                <button class="btn-submit btn btn-danger" id="reset2" onclick="reset()" hidden>
                                                    {{ __('Réinitialiser') }}
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table class="table table-bordered hide-old-regime" id="tableau" style="max-height: 200px;">
                                                <thead style="position: sticky;">
                                                    <tr class="thead-dark">
                                                        <th colspan="3" style="border: solid 2px #fff;"><center>Infos employés</center></th>
                                                        <th colspan="4" class="old-regime-col" style="border: solid 2px #fff;"><center>ITS Ancien régime</center></th>
                                                        <th colspan="3" style="border: solid 2px #fff;"><center>ITS nouveau régime</center></th>
                                                        <th style="border: solid 2px #fff;"><center> retenues fiscales</center></th>
                                                        <th colspan="2" style="border: solid 2px #fff;"><center>Retenues sociales</center></th>
                                                        <th colspan="3" style="border: solid 2px #fff;"><center> salaires nets</center></th>
                                                        <th style="border: solid 2px #fff;"><center>Observations</center></th>
                                                        <th colspan="3" style="border: solid 2px #fff;"><center>Parts patronales fiscales</center></th>
                                                        <th colspan="2" style="border: solid 2px #fff;"><center>Parts patronales sociales</center></th>
                                                        <th style="border: solid 2px #fff;"><center>Total patronales</center></th>
                                                        <th style="border: solid 2px #fff;"><center>Coût salarial</center></th>
                                                    </tr>
                                                    <tr>
                                                        <th style="background-color: #ddcd08; border: solid 2px #fff;"><center>N° Emp</center></th>
                                                        <th style="background-color: #ddcd08; border: solid 2px #fff;"><center>Nb Parts</center></th>
                                                        <th style="background-color: #ddcd08; border: solid 2px #fff;"><center>Brut Total</center></th>
                                                        <th class="old-regime-col" style="background-color: #ddcd08; border: solid 2px #fff;"><center>IS</center></th>
                                                        <th class="old-regime-col" style="background-color: #ddcd08; border: solid 2px #fff;"><center>CN</center></th>
                                                        <th class="old-regime-col" style="background-color: #ddcd08; border: solid 2px #fff;"><center>IGR</center></th>
                                                        <th class="old-regime-col" style="background-color: #ddcd08; border: solid 2px #fff;"><center>total retenues</center></th>
                                                        <th style="background-color: #ddcd08; border: solid 2px #fff;"><center>Impôts Brut</center></th>
                                                        <th style="background-color: #ddcd08; border: solid 2px #fff;"><center>RICF</center></th>
                                                        <th style="background-color: #ddcd08; border: solid 2px #fff;"><center>total retenues</center></th>
                                                        <th style="background-color: #ddcd08; border: solid 2px #fff;"><center>Différence</center></th>
                                                        <th style="background-color: #ddcd08; border: solid 2px #fff;"><center>cnps</center></th>
                                                        <th style="background-color: #ddcd08; border: solid 2px #fff;"><center>cmu</center></th>
                                                        <th style="background-color: #ddcd08; border: solid 2px #fff;"><center>Net Ancien</center></th>
                                                        <th style="background-color: #ddcd08; border: solid 2px #fff;"><center>Net Nouveau</center></th>
                                                        <th style="background-color: #ddcd08; border: solid 2px #fff;"><center>Différence</center></th>
                                                        <th style="background-color: #ddcd08; border: solid 2px #fff;"><center>Impact du nouveau régime</center></th>
                                                        <th style="background-color: #ddcd08; border: solid 2px #fff;"><center>CN</center></th>
                                                        <th style="background-color: #ddcd08; border: solid 2px #fff;"><center>CE</center></th>
                                                        <th style="background-color: #ddcd08; border: solid 2px #fff;"><center>FDFP</center></th>
                                                        <th style="background-color: #ddcd08; border: solid 2px #fff;"><center>PF / AT / CNPS</center></th>
                                                        <th style="background-color: #ddcd08; border: solid 2px #fff;"><center>CMU</center></th>
                                                        <th style="background-color: #ddcd08; border: solid 2px #fff;"><center>Somme des parts</center></th>
                                                        <th style="background-color: #ddcd08; border: solid 2px #fff;"><center>-</center></th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                </tbody>
                        ...
                        <div class="card shadow-none">
                            <div class="card-header"><div class="row">
                                <div class="col-md-6"><h5>{{ __('Resumé de Paie') }}</h5></div>
                                <div class="col-md-6" align="right" >
                                    <button onclick="generate()" id="exportpdf" target="_blanks" class="btn btn-info" >Exporter en PDF</button>
                                </div></div>
                            </div>
                                    ...
                                    <div style="margin: 0,5em;">
                                        <table class="table table-bordered pay-summary-table">
                                            <div  class="row" >
                                                ...
                                                <div id="merci" class="col-md-9" style="margin-top: 15px; margin:1em; display: none;">
                                                    <p>
                                                        Nous vous remercions d'avoir utilisé notre simulateur de paie.
                                                        Votre confiance est précieuse, et nous espérons avoir répondu à vos attentes.
                                                        N'hésitez pas à revenir pour d'autres simulations et services.
                                                    </p>
                                                </div>
                                            </div>
                                            <thead>
                                                <tr class="thead-dark">
                                                    <th colspan="8"><center><h5 style="color: #fff;">{{ __('RESUME - SIMULATION DE PAIE') }}</h5></center></th>
                                                </tr>
                                            </thead>
                                            <tr>
                                                <td><strong>Total Employé :</strong></td>
                                                <td style="background-color:black; text-align: right;"><strong><span id="totalemp" style="color:yellow;"></span><span id="totalimpan" style="display:none;"></span><span id="totalvarmasse" style="display:none;"></span></strong></td>
                                            </tr>
                                            <tr>
                                                <td><strong>Total Gain Salarial </strong></td>
                                                <td style="background-color:black; text-align: right;"><strong><span id="totalgainsal" style="color:green;"></span> <span style="color: white;">FCFA</span></strong></td>
                                                <td><strong>Total Impôts Nouveau Régime</strong></td>
                                                <td style="background-color:black; text-align: right;"><strong><span id="totalimpnv" style="color:yellow;"></span> <span style="color: white;">FCFA</span></strong></td>
                                                <td><strong>Total Parts Patronales </strong></td>
                                                <td style="background-color:black; text-align: right;"><strong><span id="totalpatron" style="color:yellow;"></span> <span style="color: white;">FCFA</span></strong></td>
                                            </tr>
                                            <tr>
                                                <td><strong>Total Perte Salariale </strong></td>
                                                <td style="background-color:black; text-align: right;"><strong><span id="totalpertsal" style="color:red;"></span> <span style="color: white;">FCFA</span></strong></td>
                                                <td><strong>Total Salaires Nets </strong></td>
                                                <td style="background-color:black; text-align: right;"><strong><span id="totalnet" style="color:yellow;"></span> <span style="color: white;">FCFA</span></strong></td>
                                                <td><strong>Total Coût Salarial </strong></td>
                                                <td style="background-color:black; text-align: right;"><strong><span id="totalcout" style="color:yellow;"></span> <span style="color: white;">FCFA</span></strong></td>
                                            </tr>
                                        </table>
                                    </div>
                                </div>
        ...
        <div id="NetBrut" class="container" style="display: none;">
            <div class="row">
                <div class="card bg-dark shadow-none">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-6"><h5 style="color: white;">{{ __('Calcul Salaire Brut') }}</h5></div>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col-md-4">
                                {{ Form::label('net_pay', __('Salaire Net à Atteindre*'), ['class' => 'col-form-label']) }}
                                {{ Form::number('net_pay', null, ['class' => 'form-control ', 'id' => 'net_pay', 'required' => 'required', 'min' => '75000', 'placeholder' => 'Net à Atteindre']) }}
                                @error('net_pay')
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="number" id="tp_brut" class="form-control" name="tp_brut" required="" min="0" placeholder="Entrez la prime de transport">
                                ...
                                <p></p>-->
                                <input type="number" id="tp_brut_libre" class="form-control" name="tp_brut_libre" required="" min="0" placeholder="Entrez la prime de transport" hidden>
                            </div>
                            <div class="form-group col-md-4">
                                {{ Form::label('cmu', __('Cotisation CMU'), ['class' => 'col-form-label']) }}
                            ...
                            <div class="form-group col-md-3">
                                {{ Form::label('situation_mat2', __('Situation matrimoniale'), ['class' => 'col-form-label']) }}
                                <select type="text" name="situation_mat2" class="form-control" id="situation_mat2" onchange="statusbrut()">
                            ...
                            <div class="form-group col-md-3">
                                {{ Form::label('emp_enfts2', __('Enfants à charge'), ['class' => 'col-form-label']) }}
                                <select type="text" name="emp_enfts2" class="form-control" id="emp_enfts2" onchange="statusbrut()">
                            ...
                            <div class="form-group col-md-3">
                                {{ Form::label('emp_personne2', __('Personnes infirmes à charge'), ['class' => 'col-form-label']) }}
                                <select type="text" name="emp_personne2" class="form-control" id="emp_personne2" onchange="statusbrut()">
                                    <option value="0">0</option>
                                    <option value="1">1</option>
                                    <option value="2">2</option>
                                    <option value="3">3</option>
                            ...
                            <div class="form-group col-md-3">
                                {{ Form::label('part_igr', __('Nombre de parts'), ['class' => 'col-form-label']) }}
                                {{ Form::number('part_igr', 1, ['class' => 'form-control ', 'id' => 'part_igr', 'placeholder' => 'Nombre de parts', 'readonly' => 'readonly'] ) }}
                            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="card shadow-none">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-6"><h5>{{ __('Resultat Salaire Brut') }} Selon le nouveau régime</h5></div>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive brut-result-wrapper">
                                <table class="table table-bordered brut-result-table" id="tableau">
                                    <thead>
                                        <tr class="thead-dark">
                                            <th style="background-color: #ddcd08; color:black; border: solid 2px #fff;"><center>Net à atteindre</center></th>
                                            <th style="background-color: #ddcd08; color:black; border: solid 2px #fff;"><center>Prime de transport</center></th>
                                            <th style="background-color: #ddcd08; color:black; border: solid 2px #fff;"><center>Nombre de parts</center></th>
                                            <!--<th style="background-color: #ddcd08; color:black; border: solid 2px #fff;"><center>Prime exonérée (10%)</center></th>-->
                                            <th style="background-color: #ddcd08; color:black; border: solid 2px #fff;"><center>Impôt Brut </center></th>
                                            <th style="background-color: #ddcd08; color:black; border: solid 2px #fff;"><center>RICF</center></th>
                                            <th style="background-color: #ddcd08; color:black; border: solid 2px #fff;"><center>Impôt net</center></th>
                                            <th style="background-color: #ddcd08; color:black; border: solid 2px #fff;"><center>CNPS</center></th>
                                            <th style="background-color: #ddcd08; color:black; border: solid 2px #fff;"><center>Bénéficiaires CMU</center></th>
                                            <th style="background-color: #ddcd08; color:black; border: solid 2px #fff;"><center>Total retenues</center></th>
                                            <th style="background-color: #ddcd08; color:black; border: solid 2px #fff;"><center>SBI</center></th>
                                            <th style="background-color: #ddcd08; color:black; border: solid 2px #fff;"><center>SBS</center></th>
                                            <th style="background-color: #ddcd08; color:black; border: solid 2px #fff;"><center>Salaire Brut</center></th>
                                            <th style="background-color: #ddcd08; color:black; border: solid 2px #fff;"><center>Parts patronales fiscales</center></th>
                                            <th style="background-color: #ddcd08; color:black; border: solid 2px #fff;"><center>Parts patronales sociales</center></th>
                                            <th style="background-color: #ddcd08; color:black; border: solid 2px #fff;"><center>Total patronales</center></th>
                                            <th style="background-color: #ddcd08; color:black; border: solid 2px #fff;"><center>Coût salarial</center></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <td><center><strong><span id="resultatnet" style="color: green;"></span></strong><center></td>
                                        <td><center><strong><span id="resultattp"></span></strong><center></td>
                                        <td><center><strong><span id="resultatpart"></span></strong><center></td>
                                        <!--<td><center><strong><span id="resultatexo"></span></strong><center></td>-->
                                        <td><center><strong><span id="resultatimp"></span></strong><center></td>
                                        <td><center><strong><span id="resultatricft"></span></strong><center></td>
                                        <td><center><strong><span id="resultatnetimp"></span></strong><center></td>
                                        <td><center><strong><span id="resultatcnps"></span></strong><center></td>
                                        <td><center><strong><span id="resultatcmu"></span></strong><center></td>
                                        <td><center><strong><span id="totalretenues"></span></strong><center></td>
                                        <td><center><strong><span id="totalsbi"></span></strong><center></td>
                                        <td><center><strong><span id="totalsbs"></span></strong><center></td>
                                        <td><center><strong><span id="resultatbrut" style="color: red;"></span></strong></center></td>
                                        <td><center><strong><span id="resultatpatfiscales"></span></strong></center></td>
                                        <td><center><strong><span id="resultatpatsociales"></span></strong></center></td>
                                        <td><center><strong><span id="resultatpatronal"></span></strong></center></td>
                                        <td><center><strong><span id="resultatcoutsal"></span></strong></center></td>
                                    </tbody>
                                </table>
                            </div>
                        </div>
    ...
    <div class="container">
        <div class="footer-row">
            <div class="ftr-col">
                ...
                <p>
                    RHFLOW une application de gestion des ressources humaines dans son ensemble.
                    Traitement des fiches de paie, gestion du personnel, etc..
                </p>
            ...
            @if ($settings['joinus_status'] == 'on')
                <div class="ftr-col ftr-subscribe">
                    <h2>Restez en contact à nous</h2>
                    <p><i>DC-KNOWING THE BESPOKE PARTNER</i></p>
                    <form method="post" action="{{ route('join_us_store') }}">
                        ...
                        <div class="input-wrapper border border-dark">
                            ...
                            <button type="submit" class="btn btn-dark rounded-pill">{{ __('Envoyer') }}</button>
                        </div>
                    </form>
                </div>
            @endif
...
<script>
    function exportToExcel() {
        ...
        for (let i = 0; i < titleInputs2.length; i++) {
            ...
            titleData2.push(titleInputs2[i].innerText.trim());
        }
        ...
        for (let i = 0; i < lastRowCells.length; i++) {
            ...
            lastRowData.push(lastRowCells[i].innerText.trim());
        }
...
<script>
    ...
    function status(npbrparts) {
        ...
        var y = document.getElementById("emp_enfts["+npbrparts+"]").value;
        var z = document.getElementById("emp_personnes["+npbrparts+"]").value;
        ...
        document.getElementById("mystatus["+npbrparts+"]").value = Math.min(nombreDeParts, 0x5);
        calculbrut(npbrparts);
    }

    function statusbrut() {
        var x = document.getElementById("situation_mat2").value;
        var y = document.getElementById("emp_enfts2").value;
        var z = document.getElementById("emp_personne2").value;
    ...
    function Resultat(){
        ...
        if (champsRemplis) {
            for (var i = 1; i <= cpte; i++) {
                ...
                if((mtsalary >= 75000) && (basesalary >= 75000) && (brut_cnps >= 75000) && (brut_cnps < 3375001)){
                    ...
                    var nbre = document.getElementById("mystatus[" + i + "]").value;
                    ...
                    cellule2.innerHTML    =  n +'<input type="text" value="'+ n +'" hidden>';
                    cellule3.innerHTML    = '<span>' + brut_total.toLocaleString()+ ' FCFA </span> <input type="text" value="'+ brut_total +'" hidden>';
                    cellule4.innerHTML    = '<span>' + resultits.toLocaleString() + ' FCFA </span> <input type="text" value="'+ resultits +'" hidden>';
                    cellule5.innerHTML    = '<span>' + resultcn.toLocaleString() + ' FCFA </span> <input type="text" value="'+ resultcn +'" hidden>';
                    cellule6.innerHTML    = '<span>' + resultigr.toLocaleString() + ' FCFA </span> <input type="text" value="'+ resultigr +'" hidden>';
                    cellule7.innerHTML    =  '<span>'+ retenue1.toLocaleString() + ' FCFA</span> <input type="text" value="'+ retenue1 +'" hidden>';
                    cellule8.innerHTML    = '<span>' + resultimpricf.toLocaleString() + ' FCFA</span> <input type="text" value="'+ resultimpricf +'" hidden>';
                    cellule9.innerHTML    = '<span>' + resultricf.toLocaleString() + ' FCFA</span> <input type="text" value="'+ resultricf +'" hidden>';
                    if(retenue2>0){
                        cellule10.innerHTML   = '<span>' + retenue2.toLocaleString() + ' FCFA</span> <input type="text" value="'+ retenue2 +'" hidden>';
                    }else{
                        cellule10.innerHTML   = '<span>' + 0 + ' FCFA</span> <input type="text" value="'+ 0 +'" hidden>';
                    }
                    cellule11.innerHTML   = '<span>' + retenue3.toLocaleString() + ' FCFA</span> <input type="text" value="'+ retenue3 +'" hidden>';
                    cellule12.innerHTML   = '<span>' + Math.round(resultcnps).toLocaleString() + ' FCFA</span> <input type="text" value="'+ Math.round(tt_cnps) +'" hidden>';
                    cellule13.innerHTML   = '<span>' + Math.round(resultcmu).toLocaleString() + ' FCFA </span> <input type="text" value="'+ resultcmu +'" hidden>';
                    cellule14.innerHTML   = '<span>' + salarynet1.toLocaleString() + ' FCFA </span> <input type="text" value="'+ salarynet1 +'" hidden>';
                    cellule15.innerHTML   = '<span>' + salarynet2.toLocaleString() + ' FCFA </span> <input type="text" value="'+ salarynet2 +'" hidden>';
                    cellule16.innerHTML   = '<span>' + variant.toLocaleString() + ' FCFA</span> <input type="text" value="'+ variant +'" hidden>';
                    if(variant>0){
                        cellule17.innerHTML   = 'Gains de : ' + variant.toLocaleString() + ' FCFA <input type="text" value="'+ variant +'" hidden>';
                    }else{
                        cellule17.innerHTML   = 'Perte de : ' + variant.toLocaleString() + ' FCFA <input type="text" value="'+ variant +'" hidden>';
                    }

                    cellule18.innerHTML   = '<span>' + Math.round(resulttax1).toLocaleString()  + ' FCFA </span> <input type="text" value="'+ resulttax1 +'" hidden>';
                    if(local){
                        cellule19.innerHTML   = '- <input type="text" value="0" hidden>' ;
                    }else{
                        cellule19.innerHTML   = '<span>' + Math.round(resulttax2).toLocaleString() + ' FCFA </span> <input type="text" value="'+ Math.round(resulttax2) +'" hidden>';
                    }
                    cellule20.innerHTML   = '<span>' + Math.round(resulttax3).toLocaleString()  + ' FCFA</span> <input type="text" value="'+ Math.round(resulttax3) +'" hidden>';
                    cellule21.innerHTML   = '<span>' + Math.round(tt_cnpsemp).toLocaleString() + ' FCFA</span> <input type="text" value="'+ Math.round(tt_cnpsemp)+'" hidden>';
                    cellule22.innerHTML   = '<span>' + coticmuemp.toLocaleString() + ' FCFA</span> <input type="text" value="'+ coticmuemp +'" hidden>';
                    cellule23.innerHTML   = '<span>' + Math.round(parpatronal).toLocaleString() + ' FCFA</span> <input type="text" value="'+ Math.round(parpatronal) +'" hidden>';
                    cellule24.innerHTML   = '<span>' + Math.round(coutsal).toLocaleString() +' FCFA</span> <input type="text" value="'+ Math.round(coutsal) +'" hidden>';
                    /*var
                    var tt_varientnet =
        ...
        if((mtsalary >= 75000) && (basesalary >= 75000) && (brut_cnps >= 75000) && (brut_cnps < 3375001)){
            ...
            var totalCellule7 = totalColonnes[6];
            var totalCellule10 = totalColonnes[9];
            //var totalCellule14 = totalColonnes[13];
            var totalCellule15 = totalColonnes[14];
            var totalCellule16 = totalColonnes[15];
            var totalCellule17 = totalColonnes[16];
            var totalCellule23 = totalColonnes[22];
            var totalCellule24 = totalColonnes[23];
    ...
    function ResultatNet(){
       ...
       // for (var i = 1; i <= cpte; i++) {
            ...
            if (mtsalary == '') {
                ...
                //nombre de part en FCFA
                var nbre = document.getElementById("mystatus2").value;
...
<script>
        ...
        for (var j = 1; j < donnees.length; j++) {
            ...
            if(champsRemplis){
                if((mtsalary >= 75000) && (basesalary >= 75000) && (brut_cnps >= 75000) && (brut_cnps < 3375001)){
                    ...
                    cellule2.innerHTML    =  nbparts +'<input type="text" value="'+ nbparts +'" hidden>';
                    cellule3.innerHTML    = '<span>' + brut_total.toLocaleString()+ ' FCFA </span> <input type="text" value="'+ brut_total +'" hidden>';
                    cellule4.innerHTML    = '<span>' + resultits.toLocaleString() + ' FCFA </span> <input type="text" value="'+ resultits +'" hidden>';
                    cellule5.innerHTML    = '<span>' + resultcn.toLocaleString() + ' FCFA </span> <input type="text" value="'+ resultcn +'" hidden>';
                    cellule6.innerHTML    = '<span>' + resultigr.toLocaleString() + ' FCFA </span> <input type="text" value="'+ resultigr +'" hidden>';
    ...
    function Resultat_brut(brut_total) {
        ...
        var brut_cnps = 0;
        if (tp_brut > 30000) {
            brut = brut_total + (tp_brut-30000)
            brut_cnps = brut_total + (tp_brut-30000)
        ...
        var resultpatcnps = Math.round(cnpsemp + (75000*0.03) + ((75000*5.75)/100));
        ...
        var totalpatronales = Math.round(partPatronalesFiscales + partPatronalesSociales);
