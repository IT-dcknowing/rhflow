                    ...
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item active">Absence @if($periode) - Période : {{ $periode->nom }} |
                                    Statut : <span
                    ...
                    <div>
                        @if($periode)
                            ...
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                data-bs-target="#createAbsenceModal">
                            ...
                            <tbody>
                                @foreach($absences as $absence)
                                    <tr>
                                        ...
                                        <td>{{ $absence->arrival_date ? \Carbon\Carbon::parse($absence->arrival_date)->format('d/m/Y') : '-' }}
                                        </td>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <a href="#" class="btn btn-icon btn-sm btn-label-info me-2 view-absence"
                                                    data-absence-id="{{ $absence->id }}" data-bs-toggle="modal"
                                                    data-bs-target="#showAbsenceModal">
                                                    <i class="fas fa-eye"></i>
                                                </a>
                                                <a href="#" class="btn btn-icon btn-sm btn-label-warning me-2 edit-absence"
                                                    data-absence-id="{{ $absence->id }}" data-bs-toggle="modal"
                                                    data-bs-target="#editAbsenceModal">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                <form action="{{ route('company.times.absences.destroy', $absence->id) }}"
                                                    method="POST" class="d-inline">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit"
                                                        class="btn btn-icon btn-sm btn-label-danger delete-confirm">
