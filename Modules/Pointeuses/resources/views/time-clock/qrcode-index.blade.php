            ...
            <div class="card-body">
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="collapse show" id="filtersCollapse">
                                <div class="card-body">
                                    <form id="filterForm" method="GET" action="{{ route('time-clock.qrcodeIndex') }}">
                                        <div class="row">
                                            <!-- Filtre par employé -->
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <a href="{{ route('time-clock.qrcodeIndex') }}" class="btn btn-secondary">
                ...
                <div class="row mb-4">
                    <div class="col-md-3 text-start">
                        <a href="{{ route('time-clock.qrcodeIndex', array_merge(request()->all(), ['year' => $previousYear, 'week' => $previousWeek])) }}"
                    ...
                    <div class="col-md-3 text-end">
                        <a href="{{ route('time-clock.qrcodeIndex', array_merge(request()->all(), ['year' => $nextYear, 'week' => $nextWeek])) }}"
                        class="btn btn-outline-primary">
                ...
                <div class="row mb-4">
                    <div class="col-md-3 text-start">
                        <a href="{{ route('time-clock.qrcodeIndex', array_merge(request()->all(), ['year' => $previousMonthYear, 'month' => $previousMonth])) }}"
                        class="btn btn-outline-primary">
                    ...
                    <div class="col-md-3 text-end">
                        <a href="{{ route('time-clock.qrcodeIndex', array_merge(request()->all(), ['year' => $nextMonthYear, 'month' => $nextMonth])) }}"
                        class="btn btn-outline-primary">
        ...
        function updateProgressBar() {
            ...
            var interval = setInterval(function() {
                if (width >= 100) {
                    ...
                    window.location.href = "{{ route('time-clock.qrcodeIndex') }}";
                } else {
