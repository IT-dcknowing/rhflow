                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <div class="progress mx-auto" style="width: 80%; height: 6px;">
                                <div class="progress-bar bg-success" style="width: {{ $totalBulletins > 0 ? round(($bulletinsValides / $totalBulletins * 100), 1) : 0 }}%"></div>
                            </div>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <div class="progress mx-auto" style="width: 80%; height: 6px;">
                                <div class="progress-bar bg-warning" style="width: {{ $totalBulletins > 0 ? round(($bulletinsEnCours / $totalBulletins * 100), 1) : 0 }}%"></div>
                            </div>
                        </div>
        ...
        <div class="card-body">
                ...
                <table class="table table-sm" id="bulletinsTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <div class="form-check">
                                    <input class="form-check-input checkbox-bulletin" type="checkbox" value="{{ $paySlip->id }}">
                                </div>
                            </td>
                            <td>
                            ...
                            <td align="right">
                                <span class="fw-semibold">{{ number_format($paySlip->salary_brut, 0, ',', ' ') }} FCFA</span>
                            </td>
                            <td align="right">
                                <span class="fw-semibold text-danger">{{ number_format($paySlip->total_retenue, 0, ',', ' ') }} FCFA</span>
                            </td>
                            <td align="right">
                                <span class="fw-semibold text-success">{{ number_format($paySlip->net_payble, 0, ',', ' ') }} FCFA</span>
                            </td>
                            <td>
                                <span class="badge bg-{{ $paySlip->status == 1 ? 'success' : ($paySlip->status == 0 ? 'warning' : 'secondary') }}">
                            ...
                            <td align="center">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a class="dropdown-item" href="{{ route('company.declarations.resume.show', $paySlip->id) }}">
                                                <i class="fas fa-eye me-2"></i>Voir
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" href="{{ route('company.declarations.resume.edit', $paySlip->id) }}">
                                                <i class="fas fa-edit me-2"></i>Modifier
                                            </a>
                                        </li>
                                        <li><hr class="dropdown-divider"></li>
                                        <li>
                                            <a class="dropdown-item text-danger" href="#" onclick="deleteBulletin({{ $paySlip->id }})">
            ...
            <div class="d-flex justify-content-between align-items-center mt-4">
                <div class="text-muted">
                    Affichage de {{ $paySlips->firstItem() }} à {{ $paySlips->lastItem() }} sur {{ $paySlips->total() }} bulletins
                </div>
                <div>
                    {{ $paySlips->links() }}
                </div>
...
<div class="modal fade" id="bulletinsAllModal" tabindex="-1" aria-labelledby="bulletinsAllModalLabel" aria-hidden="true">
