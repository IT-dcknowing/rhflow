                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="d-flex align-items-center justify-content-end">
                                ...
                                <button class="btn btn-danger me-2" id="exportPdfAnnuel"><i class="fas fa-file-pdf me-2"></i> {{ __('Pdf') }}</button>
                                <button class="btn btn-success" id="exportExelAnnuel"><i class="fas fa-file-pdf me-2"></i> {{ __('Excel') }}</button>
                            </div>
                        </div>
                    </div>
                </div>
