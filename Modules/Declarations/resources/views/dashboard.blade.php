...
@push('css')
    ...
    <style>
        ...
        .border-left-primary { border-left-color: #696cff !important; }
        .border-left-success { border-left-color: #71dd37 !important; }
        .border-left-warning { border-left-color: #ffab00 !important; }
        .border-left-info { border-left-color: #03c3ec !important; }
        .border-left-danger { border-left-color: #ff3e1d !important; }
        .stat-icon {
            font-size: 2.5rem;
            opacity: 0.8;
        }
        .priority-elevee { color: #ff3e1d; }
        .priority-moyenne { color: #ffab00; }
        .priority-normale { color: #71dd37; }
        .status-soumis { background-color: #e7f9e7; color: #2e7d32; }
        .status-encours { background-color: #fff3e0; color: #f57c00; }
        .status-brouillon { background-color: #f3e5f5; color: #7b1fa2; }
        .status-valide { background-color: #e3f2fd; color: #1976d2; }
    </style>
@endpush
        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-muted mb-0">Gestion des livres de paie annuels, mensuels, individuels et déclarations (ITS, CMU, CNPS)</p>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h3 class="card-title mb-0">{{ number_format($stats['total_bulletins_annuel'], 0, ',', ' ') }}</h3>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h3 class="card-title mb-0">{{ number_format($stats['total_bulletins_mensuel'], 0, ',', ' ') }}</h3>
                            <div class="d-flex align-items-center mt-2">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h3 class="card-title mb-0">{{ number_format($stats['total_declarations_cnps'], 0, ',', ' ') }}</h3>
                            <div class="d-flex align-items-center mt-2">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h3 class="card-title mb-0">{{ number_format($stats['total_declarations_its'] + $stats['total_declarations_cmu'], 0, ',', ' ') }}</h3>
                            <div class="d-flex align-items-center mt-2">
    ...
    <div class="row mb-4">
        ...
        <div class="col-lg-8 mb-4">
            <div class="card h-100">
                ...
                <div class="card-body">
                    <div id="declarationsEvolutionChart" 
                         data-cnps="@json($declarationsEvolution['cnps'])"
                         data-its="@json($declarationsEvolution['its'])"
                         data-cmu="@json($declarationsEvolution['cmu'])"
                         data-labels="@json($declarationsEvolution['labels'])"
                            ...
                            <div class="d-flex justify-content-between align-items-start">
                                <div class="flex-grow-1">
                                    <div class="d-flex align-items-center mb-1">
                                        <span class="badge bg-{{ $echeance->type === 'CNPS' ? 'warning' : ($echeance->type === 'ITS' ? 'info' : 'primary') }} me-2">
                                            {{ $echeance->type }}
                                        </span>
                                        <small class="priority-{{ $echeance->priorite === 'Élevée' ? 'elevee' : ($echeance->priorite === 'Moyenne' ? 'moyenne' : 'normale') }}">
                                ...
                                <div>
                                    <span class="badge status-{{ $echeance->statut === 'Soumis' ? 'soumis' : ($echeance->statut === 'En cours' ? 'encours' : 'brouillon') }}">
                                        {{ $echeance->statut }}
                                    </span>
                                </div>
                            </div>
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="fw-semibold">{{ number_format($bulletin->salaire_net, 0, ',', ' ') }} FCFA</span>
                                    </td>
                                    <td>
                                        <span class="badge status-{{ $bulletin->statut === 'Validé' ? 'valide' : ($bulletin->statut === 'Généré' ? 'soumis' : 'brouillon') }}">
                                            {{ $bulletin->statut }}
                                        </span>
                                    </td>
                                    <td>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <span class="badge bg-{{ $declaration->type === 'CNPS' ? 'warning' : ($declaration->type === 'ITS' ? 'info' : 'primary') }}">
                                            {{ $declaration->type }}
                                        </span>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <span class="badge bg-label-secondary">{{ $declaration->employes_concernes }}</span>
                                    </td>
                                    <td>
                                        <span class="fw-semibold">{{ number_format($declaration->montant_total, 0, ',', ' ') }} FCFA</span>
                                    </td>
                                    <td>
                                        <span class="badge status-{{ $declaration->statut === 'Soumis' ? 'soumis' : ($declaration->statut === 'En cours' ? 'encours' : 'brouillon') }}">
                                            {{ $declaration->statut }}
                                        </span>
                                    </td>
                                    <td>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-3">
                            <a href="#" class="btn btn-outline-info w-100 h-100 d-flex flex-column align-items-center justify-content-center" style="min-height: 100px;">
                                <i class="fas fa-receipt fa-2x mb-2"></i>
                                <span>Déclaration ITS</span>
                            </a>
                        </div>
                        <div class="col-md-3 mb-3">
                            <a href="#" class="btn btn-outline-warning w-100 h-100 d-flex flex-column align-items-center justify-content-center" style="min-height: 100px;">
