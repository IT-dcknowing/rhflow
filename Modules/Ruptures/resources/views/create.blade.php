...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <form id="createRuptureForm" method="POST" action="{{ route('company.ruptures.store') }}"
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="hidden" id="periode_id" name="periode_id" class="form-control"
                                        value="{{ $periode->id }}" required />
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    <label class="form-label" for="rupture_type_id">Type de rupture <span
                                            class="text-danger">*</span></label>
                                    <select id="rupture_type_id" name="rupture_type_id" class="select2 form-select"
                                        data-allow-clear="true" required>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" id="request_date" name="request_date"
                                        class="form-control flatpickr-date" placeholder="DD-MM-YYYY" required />
                                    @error('request_date')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                    ...
                                    <div class="form-group col-lg-6 col-md-6">
                                        ...
                                        <div id="gratification_amount" style="display: none;">
                                            <input type="number" name="gratification_amount_input" class="form-control"
                                                ...
                                                id="gratification_amount_input" oninput="getRetenues()">
                                        </div>
                                    </div>
                                    <div class="form-group col-lg-6 col-md-6">
                                        ...
                                        <div id="conge_2021_amount" style="display: none;">
                                            <input type="number" name="conge_2021_amount_input" class="form-control"
                                                ...
                                                id="conge_2021_amount_input" oninput="getRetenues()">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="form-group col-lg-6 col-md-6 mb-3">
                                        ...
                                        <div id="preavis_amount" style="display: none;">
                                            <input type="number" name="preavis_amount_input" class="form-control"
                                                placeholder="Montant de l'indemnité de préavis" id="preavis_amount_input"
                                                oninput="getRetenues()">
                                        </div>
                                    </div>
                                    <div class="form-group col-lg-6 col-md-6 mb-3">
                                        <input type="checkbox" name="specific_rights[]" value="aggravation_preavis"
                                            id="aggravation_preavis">
                                        ...
                                        <div id="aggravation_preavis_amount" style="display: none;">
                                            <input type="number" name="aggravation_preavis_amount_input"
                                                ...
                                                id="aggravation_preavis_amount_input" oninput="getRetenues()">
                                        </div>
                                    </div>
                                    <div class="form-group col-lg-6 col-md-6 mb-3">
                                        ...
                                        <div id="licenciement_amount" style="display: none;">
                                            <input type="number" name="licenciement_amount_input" class="form-control"
                                                ...
                                                id="licenciement_amount_input" oninput="getRetenues()">
                                        </div>
                                    </div>
                                    <div class="form-group col-lg-6 col-md-6 mb-3">
                                        <input type="checkbox" name="specific_rights[]" value="dommages_interets"
                                            id="dommages_interets">
                                        ...
                                        <div id="dommages_interets_amount" style="display: none;">
                                            <input type="number" name="dommages_interets_amount_input" class="form-control"
                                                ...
                                                id="dommages_interets_amount_input" oninput="getRetenues()">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-lg-4 col-md-4 mb-3">
                                        ...
                                        <div id="amount_cnps" style="display: block;">
                                            <input type="number" name="amount_cnps" class="form-control" id="montant_cnps"
                                                readonly>
                                            <input type="text" name="nbre_parts" class="form-control" required hidden
                                                id="nbre_parts">
                                        </div>
                                    </div>
                                    <div class="form-group col-lg-4 col-md-4">
                                        ...
                                        <div id="amount_its" style="display: block;">
                                            <input type="number" name="amount_its" class="form-control" id="montant_its"
                                                readonly>
                                        </div>
                                    </div>
                                    <div class="form-group col-lg-4 col-md-4">
                                        ...
                                        <div id="amount_loan" style="display: block;">
                                            <input type="number" name="amount_loan" class="form-control" placeholder="Prêts"
                                                id="montant_loan">
                                        </div>
                                    </div>
                                </div>
