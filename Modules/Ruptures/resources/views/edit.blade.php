    ...
    <div class="row">
        <div class="col-12">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('company.ruptures.update', $rupture->id) }}" method="POST" enctype="multipart/form-data" id="editRuptureForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row mb-3">
                           ...
                           {{ $rupture->contract }}
                            <div class="col-md-6">
                                ...
                                <input type="text" id="type_contrat" name="type_contrat" class="form-control" value="{{ $contracts->type->name ?? '' }}" readonly />
                                <input type="hidden" id="type_contrat_id" name="type_contrat_id" value="{{ $contracts->type->id ?? '' }}" />
                                <input type="hidden" id="periode_id" name="periode_id" value="{{ $rupture->periode_id }}" required />
                                <input type="hidden" id="contract_id" name="contract_id" value="{{ $rupture->contract_id }}" />
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                ...
                                <select id="rupture_type_id" name="rupture_type_id" class="form-select select2" required>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" id="request_date" name="request_date" class="form-control flatpickr-date" 
                                       placeholder="DD-MM-YYYY" value="{{ \Carbon\Carbon::parse($rupture->notice_date)->format('d-m-Y') }}" required />
                                @error('request_date')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-4">
                                ...
                                <input type="text" id="effective_date" name="effective_date" class="form-control flatpickr-date" 
                                       placeholder="DD-MM-YYYY" value="{{ \Carbon\Carbon::parse($rupture->termination_date)->format('d-m-Y') }}" required />
                        ...
                        <div class="row mb-3">
                            <div class="col-12">
                                ...
                                <textarea name="description" id="description" class="form-control">{{ $rupture->description }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror  
                            </div>
                                ...
                                <div id="legal_rights" style="display: block;">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-lg-6 col-md-6">
                                            <input type="checkbox" name="legal_rights[]" value="gratification" id="gratification" {{ $rupture->indem_comp > 0 ? 'checked' : '' }}>
                                            <label for="gratification">Indemnité compensatrice de Gratification</label>
                                            <div id="gratification_amount" style="display: {{ $rupture->indem_comp > 0 ? 'block' : 'none' }};">
                                                <input type="number" name="gratification_amount_input" class="form-control" 
                                                       placeholder="Montant de l'indemnité compensatrice de Gratification" 
                                                       id="gratification_amount_input" value="{{ $rupture->indem_comp }}" oninput="getRetenues()">
                                            </div>
                                        </div>
                                        <div class="form-group col-lg-6 col-md-6">
                                            <input type="checkbox" name="legal_rights[]" value="conge_2021" id="conge_2021" {{ $rupture->indem_comp_cong > 0 ? 'checked' : '' }}>
                                            <label for="conge_2021">Indemnité compensatrice de congé</label>
                                            <div id="conge_2021_amount" style="display: {{ $rupture->indem_comp_cong > 0 ? 'block' : 'none' }};">
                                                <input type="number" name="conge_2021_amount_input" class="form-control" 
                                                       ...
                                                       id="conge_2021_amount_input" value="{{ $rupture->indem_comp_cong }}" oninput="getRetenues()">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div id="specific_rights" style="display: block;">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-lg-6 col-md-6 mb-3">
                                            <input type="checkbox" name="specific_rights[]" value="preavis" id="preavis" {{ $rupture->imdem_prea > 0 ? 'checked' : '' }}>
                                            <label for="preavis">Indemnité de préavis</label>
                                            <div id="preavis_amount" style="display: {{ $rupture->imdem_prea > 0 ? 'block' : 'none' }};">
                                                <input type="number" name="preavis_amount_input" class="form-control" 
                                                       placeholder="Montant de l'indemnité de préavis" 
                                                       id="preavis_amount_input" value="{{ $rupture->imdem_prea }}" oninput="getRetenues()">
                                            </div>
                                        </div>
                                        <div class="form-group col-lg-6 col-md-6 mb-3">
                                            <input type="checkbox" name="specific_rights[]" value="aggravation_preavis" id="aggravation_preavis" {{ $rupture->indem_licence > 0 ? 'checked' : '' }}>
                                            <label for="aggravation_preavis">Aggravation de l'indemnité compensatrice de préavis</label>
                                            <div id="aggravation_preavis_amount" style="display: {{ $rupture->indem_licence > 0 ? 'block' : 'none' }};">
                                                <input type="number" name="aggravation_preavis_amount_input" class="form-control" 
                                                       placeholder="Montant de l'aggravation de l'indemnité compensatrice de préavis" 
                                                       id="aggravation_preavis_amount_input" value="{{ $rupture->indem_licence }}" oninput="getRetenues()">
                                            </div>
                                        </div>
                                        <div class="form-group col-lg-6 col-md-6 mb-3">
                                            <input type="checkbox" name="specific_rights[]" value="licenciement" id="licenciement" {{ $rupture->aggravation > 0 ? 'checked' : '' }}>
                                            <label for="licenciement">Indemnité de licenciement / fin contrat</label>
                                            <div id="licenciement_amount" style="display: {{ $rupture->aggravation > 0 ? 'block' : 'none' }};">
                                                <input type="number" name="licenciement_amount_input" class="form-control" 
                                                       placeholder="Montant de l'indemnité de licenciement" 
                                                       id="licenciement_amount_input" value="{{ $rupture->aggravation }}" oninput="getRetenues()">
                                            </div>
                                        </div>
                                        <div class="form-group col-lg-6 col-md-6 mb-3">
                                            <input type="checkbox" name="specific_rights[]" value="dommages_interets" id="dommages_interets" {{ $rupture->dom_inter > 0 ? 'checked' : '' }}>
                                            <label for="dommages_interets">Dommages et intérêts</label>
                                            <div id="dommages_interets_amount" style="display: {{ $rupture->dom_inter > 0 ? 'block' : 'none' }};">
                                                <input type="number" name="dommages_interets_amount_input" class="form-control" 
                                                       placeholder="Montant des dommages et intérêts" 
                                                       id="dommages_interets_amount_input" value="{{ $rupture->dom_inter }}" oninput="getRetenues()">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div id="specific_rights" style="display: block;">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-lg-4 col-md-4 mb-3">
                                            <input type="checkbox" name="specific_rights[]" value="cnps" id="cnps" checked>
                                            <label for="cnps">CNPS</label>
                                            <div id="cpns_amount" style="display: block;">
                                                <input type="number" name="amount_cnps" class="form-control" id="cpns_amount_input" readonly value="{{ $rupture->amount_cnps }}">
                                                <input type="hidden" name="nbre_parts" class="form-control" required value="{{ $rupture->employee->parts ?? 1 }}">
                                            </div>
                                        </div>
                                        <div class="form-group col-lg-4 col-md-4">
                                            <input type="checkbox" name="specific_rights[]" value="its" id="its" checked>
                                            <label for="its">ITS</label>
                                            <div id="its_amount" style="display: block;">
                                                <input type="number" name="amount_its" class="form-control" id="its_amount_input" readonly value="{{ $rupture->amount_its }}">
                                            </div>
                                        </div>
                                        <div class="form-group col-lg-4 col-md-4">
                                            <input type="checkbox" name="specific_rights[]" value="loan" id="loan" {{ $rupture->amount_loan > 0 ? 'checked' : '' }}>
                                            <label for="loan">Prêts</label>
                                            <div id="loan_amount" style="display: {{ $rupture->amount_loan > 0 ? 'block' : 'none' }};">
                                                <input type="number" name="amount_loan" class="form-control" 
                                                       placeholder="Montant du prêt" id="loan_amount_input" value="{{ $rupture->amount_loan }}" oninput="getRetenues()">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row mt-4">
                            <div class="col-sm-12 d-flex justify-content-between">                                
                                <a href="{{ route('company.ruptures.show', $rupture->id) }}" class="btn btn-label-danger">Annuler</a>
