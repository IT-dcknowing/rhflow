...
@push('styles')
    ...
    <style>
        .watermark {
            position: relative;
            /* Permet de positionner le texte du filigrane */
            width: 100%;
            height: 100%;
        }
        ...
        .watermark-text {
            ...
            font-size: 10em;
            /* Taille de la police du filigrane */
            opacity: 0.5;
            /* Opacité du filigrane */
            pointer-events: none;
            /* Empêcher le clic sur le filigrane */
        }

        .draft {
            color: orangered;
            /* Couleur du filigrane pour "Brouillon" */
        }

        .validated {
            color: green;
            /* Couleur du filigrane pour "Validé" */
        }

        .rejected {
            color: red;
            /* Couleur du filigrane pour "Rejeté" */
        }

        .completed {
            color: blue;
            /* Couleur du filigrane pour "Terminée" */
        }
    </style>
@endpush
                            ...
                            <div class="row mb-4">
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        {{ \Carbon\Carbon::parse($rupture->notice_date)->locale('fr')->isoFormat('DD/MM/YYYY') }}
                                    </div>
                                    <div class="mb-3">
                                        <strong>Date effective:</strong>
                                        {{ \Carbon\Carbon::parse($rupture->termination_date)->locale('fr')->isoFormat('DD/MM/YYYY') }}
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <strong>Période de préavis:</strong>
                                        {{ (int) \Carbon\Carbon::parse($rupture->notice_date)->diffInDays($rupture->termination_date) ?? 'N/A' }}
                                        jours
                                    </div>
                                    <div class="mb-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="card-body">
                                        <table class="table table-sm" id="pc-dt-simple">
                                            <tr role="row">
                                                <th colspan="3"><strong class="text-danger">I- Les droits légaux :</strong>
                                                </th>
                                            </tr>
                                            <tr role="row">
                                                <th>{{ __('Indemnité compensatrice de Gratification') }} : </th>
                                                <td align="right" colspan="2">
                                                    {{ number_format($rupture->indem_comp, '0', '.', ' ') }} FCFA</td>
                                            </tr>
                                            <tr>
                                                <th>{{ __('Indemnité compensatrice de congé 2021') }} : </th>
                                                <td align="right" colspan="2">
                                                    {{ number_format($rupture->indem_comp_cong, '0', '.', ' ') }} FCFA</td>
                                            </tr>
                                            <tr role="row">
                                                <th colspan="3"><strong class="text-danger">II- Les droits spécifiques
                                                        :</strong></th>
                                            </tr>
                                            <tr>
                                                <th>{{ __('Indemnité de préavis') }} : </th>
                                                <td align="right" colspan="2">
                                                    {{ number_format($rupture->imdem_prea, '0', '.', ' ') }} FCFA</td>
                                            </tr>
                                            <tr>
                                                <th>{{ __('Aggravation de l\'indemnité compensatrice de préavis') }} : </th>
                                                <td align="right" colspan="2">
                                                    {{ number_format($rupture->indem_licence, '0', '.', ' ') }} FCFA</td>
                                            </tr>
                                            <tr>
                                                <th>{{ __('Indemnité de licenciement') }} : </th>
                                                <td align="right" colspan="2">
                                                    {{ number_format($rupture->aggravation, '0', '.', ' ') }} FCFA</td>
                                            </tr>
                                            <tr>
                                                <th>{{ __('Dommages et intérêts') }} : </th>
                                                <td align="right" colspan="2">
                                                    {{ number_format($rupture->dom_inter, '0', '.', ' ') }} FCFA</td>
                                            </tr>
                                            <tr>
                                                <th>Total Droits Brut : </th>
                                                <td align="right" colspan="2">
                                                    <strong>{{number_format(($rupture->indem_comp + $rupture->indem_comp_cong + $rupture->imdem_prea + $rupture->indem_licence + $rupture->aggravation + $rupture->dom_inter), '0', '.', ' ')}}
                                                        FCFA</strong></td>
                                            </tr>
                                            <tr role="row">
                                                <th colspan="3"><strong class="text-danger">III- Les retenues :</strong>
                                                </th>
                                            </tr>
                                            <tr>
                                                <th>{{ __('CNPS') }} : </th>
                                                <td align="right" colspan="2">
                                                    {{ number_format($rupture->amount_cnps, '0', '.', ' ') }} FCFA</td>
                                            </tr>
                                            <tr>
                                                <th>{{ __('ITS') }} : </th>
                                                <td align="right" colspan="2">
                                                    {{ number_format($rupture->amount_its, '0', '.', ' ') }} FCFA</td>
                                            </tr>
                                            <tr>
                                                <th>{{ __('Prêts') }} : </th>
                                                <td align="right" colspan="2">
                                                    {{ number_format($rupture->amount_loan, '0', '.', ' ') }} FCFA</td>
                                            </tr>
                                            <tr>
                                                <th>Total Droits Retenues : </th>
                                                <td align="right" colspan="2">
                                                    <strong>{{number_format(($rupture->amount_cnps + $rupture->amount_its + $rupture->amount_loan), '0', '.', ' ')}}
                                                        FCFA</strong></strong></td>
                                            </tr>
                                            @php
                                                $total = 0;
                                            ...
                                            <tr>
                                                ...
                                                <td align="right" colspan="2">
                                                    <strong>{{ number_format($total, '0', '.', ' ') }} FCFA</strong></td>
                                            </tr>
                                            @if($rupture->status == 'approved' || $rupture->status == 'completed')
                                                <tr role="row">
                                                    <th colspan="3"><strong class="text-danger">IV- Les documents :</strong>
                                                    </th>
                                                </tr>
                                                <tr>
                                                        ...
                                                        <div class="dt-buttons btn-group flex-wrap">
                                                            <div class="btn-group">
                                                                <button class="btn btn-success dropdown-toggle" type="button"
                                                                    ...
                                                                    aria-expanded="false">
                                                                    <i
                                                                        class="ti ti-chevron-down me-1"></i>{{ __('Decompte des droits de rupture') }}
                                                                </button>
                                                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                                    <li>
                                                                        <a href="{{ route('company.ruptures.decompte.download.pdf', $rupture->id) }}"
                                                                    ...
                                                                    <li>
                                                                        <a href="{{ route('company.ruptures.decompte.download.doc', $rupture->id) }}"
                                                                            class=" btn-icon dropdown-item"
                                                                            data-bs-toggle="tooltip" data-bs-placement="top"
                                                                            target="_blanks"><i
                                                        ...
                                                        <div class="dt-buttons btn-group flex-wrap">
                                                            <div class="btn-group">
                                                                <button class="btn btn-primary dropdown-toggle" type="button"
                                                                    ...
                                                                    aria-expanded="false">
                                                                    <i
                                                                        class="ti ti-chevron-down me-1"></i>{{ __('Relevé nominatif des salaires') }}
                                                                </button>
                                                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                                    <li>
                                                                        <a href="{{ route('company.ruptures.releve.download.pdf', $rupture->id) }}"
                                                                            class=" btn-icon dropdown-item"
                                                                            data-bs-toggle="tooltip" data-bs-placement="top"
                                                                            target="_blanks"><i
                                                                                class="ti ti-download ">&nbsp;</i>{{ __('PDF') }}</a>
                                                                    ...
                                                                    <li>
                                                                        <a href="{{ route('company.ruptures.releve.download.doc', $rupture->id) }}"
                                                                            class=" btn-icon dropdown-item"
                                                                            data-bs-toggle="tooltip" data-bs-placement="top"
                                                                            target="_blanks"><i
                                                                                class="ti ti-download ">&nbsp;</i>{{ __('DOC') }}</a>
                                                        ...
                                                        <div class="dt-buttons btn-group flex-wrap">
                                                            <div class="btn-group">
                                                                <button class="btn btn-warning dropdown-toggle" type="button"
                                                                    ...
                                                                    aria-expanded="false">
                                                                    <i
                                                                        class="ti ti-chevron-down me-1"></i>{{ __('Solde de compte') }}
                                                                </button>
                                                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                                    <li>
                                                                        <a href="{{ route('company.ruptures.solde.download.pdf', $rupture->id) }}"
                                                                            class=" btn-icon dropdown-item"
                                                                            data-bs-toggle="tooltip" data-bs-placement="top"
                                                                            target="_blanks"><i
                                                                                class="ti ti-download ">&nbsp;</i>{{ __('PDF') }}</a>
                                                                    ...
                                                                    <li>
                                                                        <a href="{{ route('company.ruptures.solde.download.doc', $rupture->id) }}"
                                                                            class=" btn-icon dropdown-item"
                                                                            data-bs-toggle="tooltip" data-bs-placement="top"
                                                                            target="_blanks"><i
                                                                                class="ti ti-download ">&nbsp;</i>{{ __('DOC') }}</a>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex flex-wrap justify-content-between gap-2">
                                            <a href="{{ route('company.ruptures.edit', $rupture->id) }}"
                                                class="btn btn-primary {{ $rupture->status == 'approved' || $rupture->status == 'completed' ? 'disabled' : '' }}">
                                            ...
                                            @endif
                                            <button type="button"
                                                class="btn btn-label-danger {{ $rupture->status == 'completed' ? 'disabled' : '' }}"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="approveForm" action="{{ route('company.ruptures.change-status', $rupture->id) }}"
                        method="POST">
                        @csrf
                        <div class="mb-3">
    ...
    <div class="modal fade" id="rejectModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="rejectForm" action="{{ route('company.ruptures.change-status', $rupture->id) }}"
                        method="POST">
                        @csrf
                        <div class="mb-3">
                            <input type="hidden" name="status" value="rejected">
                            <label for="description" class="form-label">Motif du rejet <span
    ...
    <div class="modal fade" id="completeModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="completeForm" action="{{ route('company.ruptures.change-status', $rupture->id) }}"
                        method="POST">
                        @csrf
                        <div class="mb-3">
                            <input type="hidden" name="status" value="completed">
                            <label for="termination_date" class="form-label">Date de fin effective <span
                                    class="text-danger">*</span></label>
