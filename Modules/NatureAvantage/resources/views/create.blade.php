            ...
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex gap-2">
                        @if($periode)
                        <a href="{{ route('company.avantages.index') }}?periode_id={{$periode->id}}" class="btn btn-primary me-2">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form id="avantageForm" class="row g-3" action="{{ route('company.avantages.store') }}" method="POST">
                            @csrf
                            ...
                            <div id="avantage_argent" style="display: none;">
                                <div class="form-group  col-lg-12">
                                    <label class="form-label" for="description">Libellé de l'avantage en argent <span class="text-danger">*</span></label>
                                    <input type="text" id="description" name="description" class="form-control" placeholder="Nom de l'avantage en argent" />
                                </div>
                            </div>
                            <div class="form-group col-lg-6 col-md-6">
                            ...
                            <div class="form-group col-lg-6 col-md-6">
                                ...
                                <input type="number" id="amount_real" name="amount_real" class="form-control" placeholder="Montant réel" />
                            </div>
                            <div id="avantage_nature" style="display: none;" class="mb-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-3 col-md-3 mb-3">
                                        ...
                                        <input type="number" id="montant_logement" name="montant_logement" class="form-control" placeholder="Montant logement"/>
                                    </div>
                                    <div class="form-group col-lg-3 col-md-3 mb-3">
                                        <label class="form-label" for="montant_mobilier">Montant  pour le mobilier <span class="text-danger">*</span></label>
                                        <input type="number" id="montant_mobilier" name="montant_mobilier" class="form-control" placeholder="Montant mobilier"/>
                                    </div>
                                    <div class="form-group col-lg-3 col-md-3 mb-3">
                                        <label class="form-label" for="electric">Montant  pour l'électricité <span class="text-danger">*</span></label>
                                        <input type="number" id="electric" name="electric" class="form-control" placeholder="Montant électricité"/>
                                    </div>
                                    <div class="form-group col-lg-3 col-md-3 mb-3">
                                        <label class="form-label" for="montant_eau">Montant  pour l'eau <span class="text-danger">*</span></label>
                                        <input type="number" id="montant_eau" name="montant_eau" class="form-control" placeholder="Montant eau"/>
                                    </div>
                                </div>
                                <hr>
                                <div class="card-header">
                                ...
                                <div class="row">
                                    <div class="form-group col-lg-4 col-md-4">
                                        ...
                                        <div id="gardien_jardinier" style="display: none;">
                                            <input type="number" name="amount_garde" id="amount_garde" class="form-control" placeholder="Montant gardien">
                                        </div>
                                    </div>
                                    <div class="form-group col-lg-4 col-md-4">
                                        ...
                                        <div id="gens_maison" style="display: none;">
                                            <input type="number" name="amount_maison" id="amount_maison" class="form-control" placeholder="Montant maison">
                                        </div>
                                    </div>
                                    <div class="form-group col-lg-4 col-md-4">
                                        ...
                                        <div id="cuisinier" style="display: none;">
                                            <input type="number" name="amount_cuisto" id="amount_cuisto" class="form-control" placeholder="Montant cuisinier">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div id="divFractionExoneree" style="display: none;" class="mb-4">
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="number" name="taxe_its" id="taxe_its" class="form-control" placeholder="Montant FISC">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="taxe_cnps" class="form-label">Fraction exonérée CNPS</label>
                                        <input type="number" name="taxe_cnps" id="taxe_cnps" class="form-control" placeholder="Montant CNPS">
                                    </div>
                                </div>
                            </div>
