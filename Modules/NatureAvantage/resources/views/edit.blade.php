        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form id="avantageForm" class="row g-3"
                            action="{{ route('company.avantages.update', $avantage->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <input type="hidden" name="id_avantage" id="id_avantage" class="form-control"
                                value="{{$avantage->id}}">
                            <div class="form-group col-lg-6 col-md-6">
                                ...
                                <select id="type_avantage" name="type_avantage" class="form-select select2" required>
                                    ...
                                    <option value="assurance_vie_complementaire" {{ $avantage->type_avantage == 'assurance_vie_complementaire' ? 'selected' : '' }}>
                                        Assurance-vie complémentaire</option>
                            ...
                            <div id="avantage_argent" style="display: none;">
                                <div class="form-group  col-lg-12">
                                    <label class="form-label" for="description">Libellé de l'avantage <span
                                            class="text-danger">*</span></label>
                                    <input type="text" id="description" name="description" class="form-control"
                                        placeholder="Nom de l'avantage en argent" value="{{$avantage->libelle}}" />
                                    @error('description')
                            ...
                            <div class="form-group col-lg-6 col-md-6">
                                ...
                                <select id="traitement" name="traitement" class="form-control select2"
                                    ...
                                    <option value="mensuel" {{ $avantage->traitement == 'mensuel' ? 'selected' : '' }}>Mensuel
                                    </option>
                                    <option value="annuel" {{ $avantage->traitement == 'annuel' ? 'selected' : '' }}>Annuel
                                    </option>
                                </select>
                                @error('traitement')
                            ...
                            <div class="form-group col-lg-6 col-md-6">
                                ...
                                <input type="number" id="amount_real" name="amount_real" class="form-control"
                                    placeholder="Montant réel" value="{{$avantage->montant_reel}}" />
                                @error('amount_real')
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-3 col-md-3 mb-3">
                                        ...
                                        <input type="number" id="montant_logement" name="montant_logement"
                                            ...
                                            value="{{$avantage->montant_logement}}" />
                                    </div>
                                    <div class="form-group col-lg-3 col-md-3 mb-3">
                                        ...
                                        <input type="number" id="montant_mobilier" name="montant_mobilier"
                                            ...
                                            value="{{$avantage->montant_mobilier}}" />
                                    </div>
                                    <div class="form-group col-lg-3 col-md-3 mb-3">
                                        ...
                                        <input type="number" id="electric" name="electric" class="form-control"
                                            placeholder="Montant électricité" value="{{$avantage->montant_electricite}}" />
                                    </div>
                                    <div class="form-group col-lg-3 col-md-3 mb-3">
                                        ...
                                        <input type="number" id="montant_eau" name="montant_eau" class="form-control"
                                            placeholder="Montant eau" value="{{$avantage->montant_eau}}" />
                                    </div>
                                </div>
                                <hr>
                                <div class="card-header">
